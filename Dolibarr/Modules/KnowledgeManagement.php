 ...
 */
class KnowledgeManagement extends DolibarrModules
{
    /**
    ...
    public function __construct($db)
    {
        ...
        $this->module_parts = array(
            ...
            'css' => array(//    '/knowledgemanagement/css/knowledgemanagement.css.php',
            ),
            // Set this to relative path of js file if module must load a js on all pages
            'js' => array(//   '/knowledgemanagement/js/knowledgemanagement.js.php',
            ),

 ...
 */
class Zapier extends DolibarrModules
{
    /**
    ...
    public function __construct($db)
    {
        ...
        $this->module_parts = array(
            ...
            'css' => array(//    '/zapier/css/zapier.css.php',
            ),
            // Set this to relative path of js file if module must load a js on all pages
            'js' => array(//   '/zapier/js/zapier.js.php',
            ),
        ...
        // );
        $this->const = array(// 1 => array('ZAPIERFORDOLIBARR_MYCONSTANT', 'chaine', 'avalue', 'This is a constant to add', 1, 'allentities', 1)
        );

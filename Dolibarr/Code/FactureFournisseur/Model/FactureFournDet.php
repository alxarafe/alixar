 ...
 *
 * @property FactureFourn $facture_fourn
...
class FactureFournDet extends Model
{
    ...
    {
        return $this->belongsTo(FactureFourn::class, 'fk_facture_fourn');
    }
    ...
    {
        return $this->hasMany(SocieteRemiseExcept::class, 'fk_invoice_supplier_line');
    }
}

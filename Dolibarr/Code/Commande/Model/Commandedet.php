 ...
 * @property CommandeFournisseurdet|null $commande_fournisseurdet
...
class Commandedet extends Model
{
    ...
    {
        return $this->belongsTo(Commande::class, 'fk_commande');
    }

    public function commande_fournisseurdet()
    {
        return $this->belongsTo(CommandeFournisseurdet::class, 'fk_commandefourndet');
    }

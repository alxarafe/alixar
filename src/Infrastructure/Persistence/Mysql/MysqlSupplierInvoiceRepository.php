...
use App\Domain\SupplierInvoice\SupplierInvoice;
use App\Domain\SupplierInvoice\SupplierInvoiceRepository;
use App\Infrastructure\DolibarrMappingTrait;
use PDO;

class MysqlSupplierInvoiceRepository implements SupplierInvoiceRepository
{
    ...
    public function updateLine(int $invoiceId, int $lineId, array $data): void
    {
        ...
        $sql = sprintf("UPDATE {$this->table}_det SET %s WHERE rowid = :lineId AND fk_facture_fourn = :invoiceId", implode(', ', $sets));

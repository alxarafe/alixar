...
use App\Domain\SupplierOrder\SupplierOrder;
use App\Domain\SupplierOrder\SupplierOrderRepository;
...
class SupplierOrderApiController
{
     ...
     */
    private function mapResponse(SupplierOrder $order): array
    {
    ...
    public function list(): void
    {
        ...
        $response = array_map(function (SupplierOrder $order) {
    ...
    public function create(): void
    {
        try {
            ...
            $order = SupplierOrder::fromArray($cleanData);

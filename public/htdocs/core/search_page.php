...
if ($conf->use_javascript_ajax && 1 == 2) {   // select2 is not best with smartphone
    ...
    $selected = -1;
    $searchform .= '<br><br>' . $form->selectArrayAjax('searchselectcombo', constant('BASE_URL') . '/core/ajax/selectsearchbox.php', $selected, '', '', 0, 1, 'minwidth300', 1, $langs->trans("Search"), 0);
} else {

...
class box_shipments extends ModeleBoxes
{
    ...
    public function loadBox($max = 5)
    {
        ...
        $this->info_box_head = array(
            'text' => $langs->trans("BoxTitleLastCustomerShipments", $max) . '<a class="paddingleft" href="' . constant('BASE_URL') . '/expedition/list.php?sortfield=e.tms&sortorder=DESC"><span class="badge">...</span></a>'
        );

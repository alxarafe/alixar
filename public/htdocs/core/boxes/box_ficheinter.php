...
class box_ficheinter extends ModeleBoxes
{
    ...
    public function loadBox($max = 10)
    {
        ...
        $this->info_box_head = array(
            'text' => $langs->trans("BoxTitleLastFicheInter", $max) . '<a class="paddingleft" href="' . constant('BASE_URL') . '/fichinter/list.php?sortfield=f.tms&sortorder=DESC"><span class="badge">...</span></a>'
        );

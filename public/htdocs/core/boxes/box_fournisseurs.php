...
class box_fournisseurs extends ModeleBoxes
{
    ...
    public function loadBox($max = 5)
    {
        ...
        $this->info_box_head = array(
            'text' => $langs->trans("BoxTitleLastModifiedSuppliers", $max) . '<a class="paddingleft" href="' . constant('BASE_URL') . '/societe/list.php?type=f&sortfield=s.tms&sortorder=DESC"><span class="badge">...</span></a>'
        );

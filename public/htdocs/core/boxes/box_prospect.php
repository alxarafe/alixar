...
class box_prospect extends ModeleBoxes
{
    ...
    public function loadBox($max = 5)
    {
        ...
        $this->info_box_head = array(
            'text' => $langs->trans("BoxTitleLastModifiedProspects", $max) . '<a class="paddingleft" href="' . constant('BASE_URL') . '/societe/list.php?type=p&sortfield=s.tms&sortorder=DESC"><span class="badge">...</span></a>',
        );

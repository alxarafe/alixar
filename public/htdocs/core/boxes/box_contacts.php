...
class box_contacts extends ModeleBoxes
{
    ...
    public function loadBox($max = 5)
    {
        ...
        $this->info_box_head = array(
            'text' => $langs->trans("BoxTitleLastModifiedContacts", $max) . '<a class="paddingleft" href="' . constant('BASE_URL') . 'contact/list.php?sortfield=p.tms&sortorder=DESC"><span class="badge">...</span></a>'
        );

...
class mailing_thirdparties extends MailingTargets
{
    ...
    public function add_to_target($mailing_id)
    {
        ...
        if ($result) {
            ...
            dol_syslog(get_only_class($this) . "::add_to_target mailing " . $num . " targets found");
    ...
    public function formFilter()
    {
        ...
        if (getDolGlobalInt('MAIN_MULTILANGS')) {
            ...
            $s .= FormAdmin::selectLanguage(GETPOST('filter_lang_thirdparties', 'aZ09'), 'filter_lang_thirdparties', 0, null, $langs->trans("DefaultLang"), 0, 0, '', 0, 0, 0, null, 1);
        }
    ...
    {
        return '<a href="' . constant('BASE_URL') . '/societe/card.php?socid=' . $id . '">' . img_object('', "company") . '</a>';
    }
}

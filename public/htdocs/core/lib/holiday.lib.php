...
function holiday_prepare_head($object)
{
    ...
    $head[$h][0] = constant('BASE_URL') . '/holiday/card.php?id=' . $object->id;
    ...
    $head[$h][0] = constant('BASE_URL') . '/holiday/document.php?id=' . $object->id;
    ...
    $head[$h][0] = constant('BASE_URL') . '/holiday/info.php?id=' . $object->id;
...
function holiday_admin_prepare_head()
{
    ...
    $head[$h][0] = constant('BASE_URL') . '/admin/holiday.php';
    ...
    $head[$h][0] = constant('BASE_URL') . '/admin/holiday_extrafields.php';

...
function fiscalyear_prepare_head(Fiscalyear $object)
{
    ...
    $head[$h][0] = constant('BASE_URL') . '/accountancy/admin/fiscalyear_card.php?id=' . $object->id;
    ...
    $head[$h][0] = constant('BASE_URL') . '/accountancy/admin/fiscalyear_info.php?id=' . $object->id;

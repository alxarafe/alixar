...
function trip_prepare_head(Deplacement $object)
{
    ...
    $head[$h][0] = constant('BASE_URL') . '/compta/deplacement/card.php?id=' . $object->id;
    ...
    $head[$h][0] = constant('BASE_URL') . '/compta/deplacement/document.php?id=' . $object->id;
    $head[$h][1] = $langs->trans("Documents");
    $head[$h][2] = 'documents';
    $h++;

    $head[$h][0] = constant('BASE_URL') . '/compta/deplacement/info.php?id=' . $object->id;

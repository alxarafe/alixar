...
function contract_prepare_head(Contrat $object)
{
    ...
    $head[$h][0] = constant('BASE_URL') . '/contrat/card.php?id=' . $object->id;
    ...
    if (!getDolGlobalString('MAIN_DISABLE_CONTACTS_TAB')) {
        ...
        $head[$h][0] = constant('BASE_URL') . '/contrat/contact.php?id=' . $object->id;
    ...
    if (isModEnabled('ticket') && getDolGlobalString('TICKET_LINK_TO_CONTRACT_WITH_HARDLINK')) {
        $head[$h][0] = constant('BASE_URL') . '/contrat/ticket.php?id=' . $object->id;
    ...
    if (!getDolGlobalString('MAIN_DISABLE_NOTES_TAB')) {
        ...
        $head[$h][0] = constant('BASE_URL') . '/contrat/note.php?id=' . $object->id;
    ...
    $head[$h][0] = constant('BASE_URL') . '/contrat/document.php?id=' . $object->id;
    ...
    $head[$h][0] = constant('BASE_URL') . '/contrat/agenda.php?id=' . $object->id;
...
function contract_admin_prepare_head()
{
    ...
    $head[$h][0] = constant('BASE_URL') . "/admin/contract.php";
    ...
    $head[$h][0] = constant('BASE_URL') . '/contrat/admin/contract_extrafields.php';
    ...
    $head[$h][0] = constant('BASE_URL') . '/contrat/admin/contractdet_extrafields.php';

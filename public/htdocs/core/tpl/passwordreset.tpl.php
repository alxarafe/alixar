...
ViewMain::topHtmlHead('', $titleofpage, 0, 0, $arrayofjs, array(), 1, $disablenofollow);
...
?>>
                            ...
                            <div class="trinputlogin">
                                <div class="tagtd nowraponall center valignmiddle tdinputlogin">
                                    ...
                                    <input type="text" maxlength="255"
                                           placeholder="<?php echo $langs->trans("NewPassword"); ?>" <?php echo $disabled; ?>
                                           id="newpass1" name="newpass1" class="flat input-icon-user minwidth150"
                                           value="<?php echo dol_escape_htmltag($newpass1); ?>" tabindex="1" autofocus/>
                                </div>
                            </div>
                            <div class="trinputlogin">
                                <div class="tagtd nowraponall center valignmiddle tdinputlogin">
                                    ...
                                    <span class="fa fa-user"></span>
                                    <input type="text" maxlength="255"
                                           placeholder="<?php echo $langs->trans("PasswordRetype"); ?>" <?php echo $disabled; ?>
                                           id="newpass2" name="newpass2" class="flat input-icon-user minwidth150"
                                           value="<?php echo dol_escape_htmltag($newpass2); ?>" tabindex="1"/>
                                </div>
                            </div>
    ...
    <a class="inline-block valignmiddle" href="<?php echo $php_self; ?>"
       tabindex="4"><?php echo $captcha_refresh; ?></a>
    </span>
                ...
                <div id="login_line2" style="clear: both">
                    ...
                    <br><input type="submit" <?php echo $disabled; ?> class="button small" name="button_password"
                               value="<?php echo $langs->trans('Save'); ?>" tabindex="4"/>

...
if (($line->info_bits & 2) == 2) {
    print '<a href="' . constant('BASE_URL') . '/comm/remx.php?id=' . $this->socid . '">';
    $txt = '';
    ...
    if (isModEnabled('asset') && $object->element == 'invoice_supplier') {
        ...
        if (
            ...
            if (!$resql_asset) {
                ...
                if (!empty($obj->found)) {
                    print '<a class="reposition" href="' . constant('BASE_URL') . '/asset/card.php?action=create&token=' . newToken() . '&supplier_invoice_id=' . $object->id . '">';

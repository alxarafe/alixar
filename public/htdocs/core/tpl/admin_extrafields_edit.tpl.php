...
<form action="<?php echo $_SERVER["PHP_SELF"]; ?>?attrname=<?php echo $attrname; ?>" id="formeditextrafield"
      method="post">
    ...
    <input type="hidden" name="enabled"
           value="<?php echo dol_escape_htmltag($extrafields->attributes[$elementtype]['enabled'][$attrname]); ?>">
    ...
    <table summary="listofattributes" class="border centpercent">
        ...
        <tr>
            ...
            <td class="valeur"><input type="text" name="label" size="40" value="<?php echo $label; ?>"></td>
        </tr>
        ...
        <tr class="extra_size">
            ...
            <td><input id="size" type="text" name="size" class="width50" value="<?php echo $size; ?>"></td>
        </tr>
                    ...
                    <tr>
                        <td>
                            <textarea name="param" id="param" cols="80"
                                      rows="<?php echo ROWS_4 ?>"><?php echo dol_htmlcleanlastbr($param_chain); ?></textarea>
                        </td>
                        <td>
                            <span id="helpselect"
        ...
        <tr>
            ...
            <td class="valeur"><input type="text" name="pos" class="width50"
                                      value="<?php echo dol_escape_htmltag($pos); ?>"></td>
        </tr>

        <!-- Language file -->
        <tr>
            <td class="titlefield"><?php echo $langs->trans("LanguageFile"); ?></td>
            <td class="valeur"><input type="text" name="langfile" class="minwidth200"
                                      value="<?php echo dol_escape_htmltag($langfile); ?>"></td>
        </tr>
        ...
        <tr class="extra_computed_value">
            ...
            <td class="valeur"><textarea name="computed_value" id="computed_value" class="quatrevingtpercent"
                                         rows="<?php echo ROWS_4 ?>"><?php echo dol_htmlcleanlastbr($computed); ?></textarea>
            </td>
        </tr>
        ...
        <tr class="extra_default_value">
            ...
            <td class="valeur"><input id="default_value" type="text" name="default_value" class="width50"
                                      value="<?php echo dol_escape_htmltag($default); ?>"></td>
        </tr>
        ...
        <tr class="extra_unique">
            ...
            <td class="valeur"><input id="unique" type="checkbox"
                                      name="unique"<?php echo($unique ? ' checked' : ''); ?>></td>
        </tr>
        ...
        <tr class="extra_required">
            ...
            <td class="valeur"><input id="required" type="checkbox"
                                      name="required"<?php echo($required ? ' checked' : ''); ?>></td>
        </tr>
        ...
        <tr class="extra_alwayseditable">
            ...
            <td class="valeur"><input id="alwayseditable" type="checkbox"
                                      name="alwayseditable"<?php echo($alwayseditable ? ' checked' : ''); ?>></td>
        </tr>
        ...
        <tr>
            ...
            <td class="valeur"><input id="printable" class="minwidth100" type="text" name="printable"
                                      value="<?php echo dol_escape_htmltag($printable); ?>"></td>
        </tr>

        <!-- Can be summed -->
        <tr class="extra_totalizable">
            <td><?php echo $form->textwithpicto($langs->trans("Totalizable"), $langs->trans("TotalizableDesc")); ?></td>
            <td class="valeur"><input id="totalizable" type="checkbox"
                                      name="totalizable"<?php echo($totalizable ? ' checked' : ''); ?>></td>
        </tr>

        <!-- Css edit -->
        <tr class="extra_css">
            <td><?php echo $form->textwithpicto($langs->trans("CssOnEdit"), $langs->trans("HelpCssOnEditDesc")); ?></td>
            <td class="valeur"><input id="css" type="text" name="css" value="<?php echo $css ?>"></td>
        </tr>

        <!-- Css view -->
        <tr class="extra_cssview">
            <td><?php echo $form->textwithpicto($langs->trans("CssOnView"), $langs->trans("HelpCssOnViewDesc")); ?></td>
            <td class="valeur"><input id="cssview" type="text" name="cssview" value="<?php echo $cssview; ?>"></td>
        </tr>

        <!-- Css list -->
        <tr class="extra_csslist">
            <td><?php echo $form->textwithpicto($langs->trans("CssOnList"), $langs->trans("HelpCssOnListDesc")); ?></td>
            <td class="valeur"><input id="csslist" type="text" name="csslist" value="<?php echo $csslist; ?>"></td>
        </tr>
        ...
        <tr class="help">
            ...
            <td class="valeur"><input id="help" class="quatrevingtpercent" type="text" name="help"
                                      value="<?php echo dol_escape_htmltag($help); ?>"></td>
        </tr>
        ...
        <?php if (isModEnabled('multicompany')) { ?>
            ...
            <tr>
                ...
                <td class="valeur"><input id="entitycurrentorall" type="checkbox"
                                          name="entitycurrentorall"<?php echo(empty($entitycurrentorall) ? ' checked' : ''); ?>>
                </td>
            </tr>
        <?php } ?>
        ...
        <?php if ($enabled != '1') { ?>
        <tr class="help">
            <td><?php echo $langs->trans("EnabledCondition"); ?></td>
            <td class="valeur">

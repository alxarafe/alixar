        ...
        if (isModEnabled("product") || isModEnabled("service")) {
            ...
            if ($addproducton || $addserviceon) {
                if ($addproducton && $addserviceon) {
                    ...
                    echo '<a class="dropdown-item" href="' . constant('BASE_URL') . '/product/card.php?action=create&type=0&backtopage=' . urlencode($_SERVER["PHP_SELF"] . '?id=' . $object->id) . '"> ' . $langs->trans("NewProduct") . '</a>';
                    echo '<a class="dropdown-item" href="' . constant('BASE_URL') . '/product/card.php?action=create&type=1&backtopage=' . urlencode($_SERVER["PHP_SELF"] . '?id=' . $object->id) . '"> ' . $langs->trans("NewService") . '</a>';
                    echo '</div>';
                    echo '</div>';
                } else {
                    if ($addproducton) {
                        ...
                        if (getDolGlobalInt('MAIN_FEATURES_LEVEL') >= 2) {
                            ...
                            print '<a href="' . constant('BASE_URL') . '/product/card.php?action=create&type=0&backtopage=' . urlencode($_SERVER["PHP_SELF"] . '?id=' . $object->id) . '" title="' . dol_escape_htmltag($langs->trans("NewProduct")) . '"><span class="fa fa-plus-circle valignmiddle paddingleft"></span></a>';
                        }
                    }
                    if ($addserviceon) {
                        ...
                        if (getDolGlobalInt('MAIN_FEATURES_LEVEL') >= 2) {
                            ...
                            print '<a href="' . constant('BASE_URL') . '/product/card.php?action=create&type=1&backtopage=' . urlencode($_SERVER["PHP_SELF"] . '?id=' . $object->id) . '" title="' . dol_escape_htmltag($langs->trans("NewService")) . '"><span class="fa fa-plus-circle valignmiddle paddingleft"></span></a>';
                        }
                    }
                }
            } ?>

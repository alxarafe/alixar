...
ViewMain::llxHeader('', $langs->trans("CashDeskSetup"), '', '', 0, 0, $arrayofjs, $arrayofcss, '', 'mod-takepos page-admin_bar');
...
if (getDolGlobalInt('TAKEPOS_BAR_RESTAURANT')) {
    ...
    print $langs->trans("OrderPrinters") . ' (<a href="' . constant('BASE_URL') . '/takepos/admin/orderprinters.php?leftmenu=setup">' . $langs->trans("Setup") . '</a>)';
    print '</td>';
    print '<td class="">';

...
$viewmode .= '<a class="btnTitle' . ($mode == 'list' ? ' btnTitleSelected' : '') . ' btnTitleSelected reposition" href="' . constant('BASE_URL') . '/comm/action/list.php?mode=show_list&restore_lastsearch_values=1' . $paramnoactionodate . '">';
...
$viewmode .= '<a class="btnTitle' . ($mode == 'show_month' ? ' btnTitleSelected' : '') . ' reposition" href="' . constant('BASE_URL') . '/comm/action/index.php?mode=show_month&year=' . $viewyear . '&month=' . $viewmonth . '&day=' . $viewday . $paramnoactionodate . '">';
//$viewmode .= '<span class="fa paddingleft imgforviewmode valignmiddle btnTitle-icon">';
...
$viewmode .= '<a class="btnTitle' . ($mode == 'show_week' ? ' btnTitleSelected' : '') . ' reposition" href="' . constant('BASE_URL') . '/comm/action/index.php?mode=show_week&year=' . $viewyear . '&month=' . $viewmonth . '&day=' . $viewday . $paramnoactionodate . '">';
//$viewmode .= '<span class="fa paddingleft imgforviewmode valignmiddle btnTitle-icon">';
...
$viewmode .= '<a class="btnTitle' . ($mode == 'show_day' ? ' btnTitleSelected' : '') . ' reposition" href="' . constant('BASE_URL') . '/comm/action/index.php?mode=show_day&year=' . $viewyear . '&month=' . $viewmonth . '&day=' . $viewday . $paramnoactionodate . '">';
//$viewmode .= '<span class="fa paddingleft imgforviewmode valignmiddle btnTitle-icon">';
...
$viewmode .= '<a class="btnTitle' . ($mode == 'show_peruser' ? ' btnTitleSelected' : '') . ' reposition marginrightonly" href="' . constant('BASE_URL') . '/comm/action/peruser.php?mode=show_peruser&year=' . $viewyear . '&month=' . $viewmonth . '&day=' . $viewday . $paramnoactionodate . '">';
//$viewmode .= '<span class="fa paddingleft imgforviewmode valignmiddle btnTitle-icon">';

...
if (empty($reshook)) {
    ...
    $backurlforlist = constant('BASE_URL') . '/comm/mailing/list.php';
    ...
    if (empty($backtopage) || ($cancel && empty($id))) {
        if (empty($backtopage) || ($cancel && strpos($backtopage, '__ID__'))) {
            if (empty($id) && (($action != 'add' && $action != 'create') || $cancel)) {
                ...
                $backtopage = constant('BASE_URL') . '/comm/mailing/card.php?id=' . ((!empty($id) && $id > 0) ? $id : '__ID__');
            }
        }
    }
        ...
        if ($action != 'edit' && $action != 'edittxt' && $action != 'edithtml') {
            ...
            if ($action == 'sendall') {
                ...
                if (getDolGlobalString('MAILING_NO_USING_PHPMAIL') && $sendingmode == 'mail') {
                    ...
                    $linktoadminemailbefore = '<a href="' . constant('BASE_URL') . '/admin/mails_emailing.php">';

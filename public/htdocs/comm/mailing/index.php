...
print '<form method="post" action="' . constant('BASE_URL') . '/comm/mailing/list.php">';
...
if ($result) {
    ...
    print '</td>';
    print '<td class="right"><a href="' . constant('BASE_URL') . '/comm/mailing/list.php">' . $langs->trans("AllEMailings") . '</a></td>';
    print '</tr>';

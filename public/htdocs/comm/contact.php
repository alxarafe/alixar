...
if ($resql) {
    ...
    while ($i < min($num, $limit)) {
        ...
        print '<td><a href="' . constant('BASE_URL') . '/contact/card.php?id=' . $obj->cidp . '&socid=' . $obj->rowid . '">' . img_object($langs->trans("ShowContact"), "contact");
        print '</a>&nbsp;<a href="' . constant('BASE_URL') . '/contact/card.php?id=' . $obj->cidp . '&socid=' . $obj->rowid . '">' . $obj->name . '</a></td>';

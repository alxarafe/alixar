    ...
    if ($resql) {
        ...
        if ($num) {
            ...
            while ($i < $num) {
                ...
                print '<td><a href="' . constant('BASE_URL') . '/comm/card.php?socid=' . $obj->socid . '">' . img_object($langs->trans("ShowCompany"), "company") . ' ' . dol_trunc($obj->name, 24) . '</a></td></tr>';
                $i++;
            }
        }
        print "</table></div><br>";
...
if (isModEnabled('intervention')) {
    ...
    if ($resql) {
        ...
        print '<table class="noborder centpercent">';
        print '<tr class="liste_titre">';
        print '<th colspan="3">' . $langs->trans("FichinterToProcess") . ' <a href="' . constant('BASE_URL') . '/fichinter/list.php?search_status=1"><span class="badge">' . $num . '</span></a></th></tr>';
        ...
        if ($num) {
            ...
            while ($i < $num) {
                ...
                print '<td><a href="' . constant('BASE_URL') . '/comm/card.php?socid=' . $obj->socid . '">' . img_object($langs->trans("ShowCompany"), "company") . ' ' . dol_trunc($obj->name, 24) . '</a></td>';

...
function pHeader($soutitre, $next, $action = 'none')
{
    ...
    print '<link rel="stylesheet" type="text/css" href="' . constant('DOL_URL_ROOT') . '/install/default.css">' . "\n";
    ...
    print '<img src="' . constant('DOL_URL_ROOT') . '/support/helpcenter.png" alt="logohelpcenter" class="inline-block"><br><br>';

    ...
    if ($resql) {
        ...
        if ($num) {
            ...
            while ($i < $num) {
                ...
                print '<td><a href="' . constant('BASE_URL') . '/fourn/card.php?socid=' . $obj->socid . '">' . img_object($langs->trans("ShowCompany"), "company") . ' ' . dol_trunc($obj->name, 24) . '</a></td></tr>';
                $i++;
            }
        }
        print "</table></div><br>";
...
if ($resql) {
    ...
    print '<a href="' . constant('BASE_URL') . '/fourn/commande/list.php?sortfield=cf.tms&sortorder=DESC">';
    ...
    if ($num) {
        ...
        while ($i < $num) {
            ...
            print '<td><a href="' . constant('BASE_URL') . '/fourn/card.php?socid=' . $obj->socid . '">' . img_object($langs->trans("ShowCompany"), "company") . ' ' . $obj->name . '</a></td>';

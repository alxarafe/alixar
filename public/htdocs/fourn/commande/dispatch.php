...
ViewMain::llxHeader('', $title, $help_url, '', 0, 0, $morejs, '', '', 'mod-supplier-order page-card_dispatch');
...
if ($id > 0 || !empty($ref)) {
    ...
    $linkback = '<a href="' . constant('BASE_URL') . 'fourn/commande/list.php' . (!empty($socid) ? '?socid=' . $socid : '') . '">' . $langs->trans("BackToList") . '</a>';

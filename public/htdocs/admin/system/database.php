...
print '<tr class="oddeven"><td class=""><a href="' . constant('BASE_URL') . '/admin/system/database-tables.php?mainmenu=home">' . img_picto('', 'list', 'class="pictofixedwidth"') . $langs->trans("List") . '</a></td></tr>' . "\n";
print '</table>';
print '</div>';

...
ViewMain::llxHeader('', '', '', '', 0, 0, '', '', '', 'mod-admin page-system_security');
...
print '<span class="fas fa-shield-alt"></span> ' . constant('BASE_URL') . '/passwordforgotten.php (see <a target="_blank" rel="noopener" href="' . $urlexamplebase . 'web-dolibarr-rulespassforgotten.conf">fail2ban example on GitHub</a>)<br>';
print '<span class="fas fa-shield-alt"></span> ' . constant('BASE_URL') . '/public/* (see <a target="_blank" rel="noopener" href="' . $urlexamplebase . 'web-dolibarr-limitpublic.conf">fail2ban example on GitHub</a>)<br>';
print '<br>';

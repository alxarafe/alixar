...
require_once constant('DOL_DOCUMENT_ROOT') . '/emailcollector/class/emailcollector.class.php';
...
if ($num == 1 && getDolGlobalString('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
    ...
    $id = $obj->rowid;
    header("Location: " . constant('BASE_URL') . '/emailcollector/emailcollector_card.php?id=' . $id);
    exit;
}

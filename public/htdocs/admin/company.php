...
if (!empty($mysoc->logo_small)) {
    ...
    if (file_exists($conf->mycompany->dir_output . '/logos/thumbs/' . $mysoc->logo_small)) {
        ...
        print '<img id="logo" style="max-height: 80px; max-width: 200px;" src="' . constant('BASE_URL') . '/viewimage.php?modulepart=mycompany&file=' . urlencode('logos/thumbs/' . $mysoc->logo_small) . '">';
        print '</div>';
        ...
        print '<div class="inline-block valignmiddle">';
        print '<img id="logo" style="max-height: 80px; max-width: 200px;" src="' . constant('BASE_URL') . '/viewimage.php?modulepart=mycompany&amp;file=' . urlencode('logos/thumbs/' . basename($imgThumbSmall)) . '">';
        print '</div>';
    }
} elseif (!empty($mysoc->logo)) {
    if (file_exists($conf->mycompany->dir_output . '/logos/' . $mysoc->logo)) {
        print '<div class="inline-block valignmiddle">';
        print '<img id="logo" style="max-height: 80px" src="' . constant('BASE_URL') . '/viewimage.php?modulepart=mycompany&file=' . urlencode('logos/' . $mysoc->logo) . '">';
        print '</div>';
        ...
        print '<div class="inline-block valignmiddle">';
        print '<img id="logo" height="80" src="' . constant('BASE_URL') . '/public/theme/common/nophoto.png" title="File has been removed from disk">';
        print '</div>';
    }
}
print '</div>';
...
if (!empty($mysoc->logo_squarred_small)) {
    ...
    if (file_exists($conf->mycompany->dir_output . '/logos/thumbs/' . $mysoc->logo_squarred_small)) {
        print '<div class="inline-block valignmiddle marginrightonly">';
        print '<img id="logosquarred" style="height: 80px; width: 80px;" src="' . constant('BASE_URL') . '/viewimage.php?modulepart=mycompany&file=' . urlencode('logos/thumbs/' . $mysoc->logo_squarred_small) . '">';
        print '</div>';
        ...
        print '<div class="inline-block valignmiddle">';
        print '<img id="logosquarred" style="height: 80px; width: 80px;" src="' . constant('BASE_URL') . '/viewimage.php?modulepart=mycompany&file=' . urlencode('logos/thumbs/' . basename($imgThumbSmall)) . '">';
        print '</div>';
    }
    ...
    if (file_exists($conf->mycompany->dir_output . '/logos/' . $mysoc->logo_squarred)) {
        print '<div class="inline-block valignmiddle">';
        print '<img id="logosquarred" style="height: 80px; width: 80px;" src="' . constant('BASE_URL') . '/viewimage.php?modulepart=mycompany&file=' . urlencode('logos/' . $mysoc->logo_squarred) . '">';
        print '</div>';
        ...
        print '<div class="inline-block valignmiddle">';
        print '<img id="logosquarred" style="height: 80px; width: 80px;" src="' . constant('BASE_URL') . '/public/theme/common/nophoto.png" title="File has been removed from disk">';
        print '</div>';

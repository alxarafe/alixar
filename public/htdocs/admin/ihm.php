...
if ($mode == 'other') {
    ...
    print FormAdmin::selectLanguage(getDolGlobalString('MAIN_LANG_DEFAULT'), 'MAIN_LANG_DEFAULT', 1, null, '', 0, 0, 'minwidth300', 2);
...
if ($mode == 'login') {
    ...
    if (getDolGlobalString('MAIN_LOGIN_BACKGROUND')) {
        ...
        if (file_exists($conf->mycompany->dir_output . '/logos/' . getDolGlobalString('MAIN_LOGIN_BACKGROUND'))) {
            print ' &nbsp; ';
            print '<img class="marginleftonly boxshadow valignmiddle" width="100" src="' . constant('BASE_URL') . '/viewimage.php?modulepart=mycompany&amp;file=' . urlencode('logos/' . getDolGlobalString('MAIN_LOGIN_BACKGROUND')) . '">';
        }
    } else {
        print '<img class="marginleftonly valignmiddle" width="100" src="' . constant('BASE_URL') . '/public/theme/common/nophoto.png">';
    }
    print '</div>';
    print '</td></tr>';

...
require_once constant('DOL_DOCUMENT_ROOT') . '/workstation/lib/workstation.lib.php';
...
if ($action == 'updateMask') {
    ...
    if ($classname !== '') {
        ...
        if ($module->write_file($tmpobject, $langs) > 0) {
            header("Location: " . constant('BASE_URL') . "/document.php?modulepart=" . strtolower($tmpobjectkey) . "&file=SPECIMEN.pdf");
            return;
        } else {
...
ViewMain::llxHeader('', $langs->trans($page_name), $help_url, '', 0, 0, '', '', '', 'mod-admin page-workstation');

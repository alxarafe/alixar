...
if ($resql) {
    ...
    while ($i < $num) {
        ...
        if ($obj->socid) {
            print '<a href="' . constant('BASE_URL') . '/projet/list.php?socid=' . $obj->socid . '&search_status=1">' . $obj->nb . '</a>';
        } else {
            print '<a href="' . constant('BASE_URL') . '/projet/list.php?search_societe=' . urlencode('^$') . '&search_status=1">' . $obj->nb . '</a>';
        }
        print '</td>';
        print "</tr>\n";

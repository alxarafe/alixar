...
if (empty($reshook)) {
    ...
    if (!empty($withproject)) {
        $backurlforlist = constant('BASE_URL') . '/eventorganization/conferenceorboothattendee_list.php?withproject=1&fk_project=' . ((int) $fk_project);
    } else {
        $backurlforlist = constant('BASE_URL') . '/eventorganization/conferenceorboothattendee_list.php';
    }

...
function availabilitiesPrepareHead($object)
{
    ...
    $head[$h][0] = constant('BASE_URL') . '/bookcal/availabilities_card.php?id=' . $object->id;
    $head[$h][1] = $langs->trans("Card");
    $head[$h][2] = 'card';
    $h++;

    if ($showtabofpagecontact) {
        $head[$h][0] = constant('BASE_URL') . '/bookcal/availabilities_contact.php?id=' . $object->id;
    ...
    if ($showtabofpagenote) {
        if (isset($object->fields['note_public']) || isset($object->fields['note_private'])) {
            ...
            $head[$h][0] = constant('BASE_URL') . '/bookcal/availabilities_note.php?id=' . $object->id;
    ...
    if ($showtabofpagedocument) {
        ...
        $head[$h][0] = constant('BASE_URL') . '/bookcal/availabilities_document.php?id=' . $object->id;
    ...
    if ($showtabofpageagenda) {
        $head[$h][0] = constant('BASE_URL') . '/bookcal/availabilities_agenda.php?id=' . $object->id;

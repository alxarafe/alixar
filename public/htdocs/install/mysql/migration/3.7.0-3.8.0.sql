...
ALTER TABLE llx_facture_fourn
    MODIFY COLUMN ref varchar(255) NOT NULL;
...
VALUES (2131, 213, '5', '0', 'VAT 5%', 1);

ALTER TABLE llx_societe_rib
    ADD COLUMN rum varchar(32) AFTER default_rib;
ALTER TABLE llx_societe_rib
    ADD COLUMN frstrecur varchar(16) DEFAULT 'FRST' AFTER rum;

ALTER TABLE llx_cronjob
    ADD COLUMN entity integer DEFAULT 0;
...
ALTER TABLE llx_payment_salary
    ADD COLUMN salary real AFTER datev;

ALTER TABLE llx_payment_salary
    ADD INDEX idx_payment_salary_ref (num_payment);
ALTER TABLE llx_payment_salary
    ADD INDEX idx_payment_salary_user (fk_user, entity);
ALTER TABLE llx_payment_salary
    ADD INDEX idx_payment_salary_datep (datep);
ALTER TABLE llx_payment_salary
    ADD INDEX idx_payment_salary_datesp (datesp);
ALTER TABLE llx_payment_salary
    ADD INDEX idx_payment_salary_dateep (dateep);

ALTER TABLE llx_payment_salary
    ADD CONSTRAINT fk_payment_salary_user FOREIGN KEY (fk_user) REFERENCES llx_user (rowid);


UPDATE llx_projet_task_time
SET task_datehour = task_date
where task_datehour IS NULL;
ALTER TABLE llx_projet_task_time
    ADD COLUMN task_date_withhour integer DEFAULT 0 AFTER task_datehour;
...
DELETE
FROM llx_menu
where module = 'printipp';


ALTER TABLE llx_bank
    ADD INDEX idx_bank_num_releve (num_releve);
...
ALTER TABLE llx_product_fournisseur_price
    ADD COLUMN fk_supplier_price_expression integer DEFAULT NULL;
ALTER TABLE llx_product
    ADD COLUMN fk_price_expression integer DEFAULT NULL;
ALTER TABLE llx_product_price
    ADD COLUMN fk_price_expression integer DEFAULT NULL;

ALTER TABLE llx_product
    ADD COLUMN fifo double(24, 8) AFTER pmp;
ALTER TABLE llx_product
    ADD COLUMN lifo double(24, 8) AFTER fifo;
...
ALTER TABLE llx_facture
    ADD COLUMN situation_cycle_ref smallint;
ALTER TABLE llx_facture
    ADD COLUMN situation_counter smallint;
ALTER TABLE llx_facture
    ADD COLUMN situation_final smallint;
ALTER TABLE llx_facturedet
    ADD COLUMN situation_percent real;
ALTER TABLE llx_facturedet
...
UPDATE llx_const
SET entity = __ENCRYPT('1') __
WHERE __DECRYPT('entity') __ = 0 AND __DECRYPT('name') __ = 'MAIN_MAIL_SMTP_PORT';
UPDATE llx_const
SET entity = __ENCRYPT('1') __
WHERE __DECRYPT('entity') __ = 0 AND __DECRYPT('name') __ = 'MAIN_MAIL_SMTP_SERVER';
UPDATE llx_const
SET entity = __ENCRYPT('1') __
WHERE __DECRYPT('entity') __ = 0 AND __DECRYPT('name') __ = 'MAIN_MAIL_SMTPS_ID';
UPDATE llx_const
SET entity = __ENCRYPT('1') __
WHERE __DECRYPT('entity') __ = 0 AND __DECRYPT('name') __ = 'MAIN_MAIL_SMTPS_PW';
UPDATE llx_const
SET entity = __ENCRYPT('1') __
WHERE __DECRYPT('entity') __ = 0 AND __DECRYPT('name') __ = 'MAIN_MAIL_EMAIL_TLS';

-- This option with this value is not compatible with 3.8. Value must be set to 'mutiselect', 'select2'...
DELETE
from llx_const
where name = 'MAIN_USE_JQUERY_MULTISELECT'
  and value = '1';
...
ALTER TABLE llx_stock_mouvement
    MODIFY COLUMN price double(24, 8) DEFAULT 0;
ALTER TABLE llx_stock_mouvement
    ADD COLUMN inventorycode varchar(128);


ALTER TABLE llx_product_association
    ADD COLUMN incdec integer DEFAULT 1;



ALTER TABLE llx_bank_account_extrafields
    ADD INDEX idx_bank_account_extrafields (fk_object);
...
ALTER TABLE llx_contratdet_extrafields
    ADD INDEX idx_contratdet_extrafields (fk_object);

ALTER TABLE llx_product_fournisseur_price
    ADD COLUMN delivery_time_days integer;
...
ALTER TABLE llx_commande_fournisseur_dispatch
    ADD COLUMN batch varchar(30) DEFAULT NULL;
ALTER TABLE llx_commande_fournisseur_dispatch
    ADD COLUMN eatby date DEFAULT NULL;
ALTER TABLE llx_commande_fournisseur_dispatch
    ADD COLUMN sellby date DEFAULT NULL;
ALTER TABLE llx_stock_mouvement
    ADD COLUMN batch varchar(30) DEFAULT NULL;
ALTER TABLE llx_stock_mouvement
    ADD COLUMN eatby date DEFAULT NULL;
...
UPDATE llx_product_batch
SET batch = 'unknown'
WHERE batch IS NULL;
ALTER TABLE llx_product_batch
    MODIFY COLUMN batch varchar(30) NOT NULL;
...
ALTER TABLE llx_projet
    ADD COLUMN budget_amount double(24, 8);
-- Alias names (commercial, trademark or alias names)
ALTER TABLE llx_societe
    ADD COLUMN name_alias varchar(128) NULL;
...
ALTER TABLE llx_commande_fournisseurdet_extrafields
    ADD INDEX idx_commande_fournisseurdet_extrafields (fk_object);
...
ALTER TABLE llx_facture_fourn_det
    ADD COLUMN special_code integer DEFAULT 0;
ALTER TABLE llx_facture_fourn_det
...
ALTER TABLE llx_commande_fournisseurdet
    ADD COLUMN rang integer DEFAULT 0;
ALTER TABLE llx_commande_fournisseurdet
    ADD COLUMN fk_parent_line integer NULL AFTER fk_commande;

ALTER TABLE llx_projet
    ADD COLUMN date_close datetime DEFAULT NULL;
ALTER TABLE llx_projet
    ADD COLUMN fk_user_close integer DEFAULT NULL;
ALTER TABLE llx_projet
    ADD COLUMN fk_opp_status integer DEFAULT NULL AFTER fk_statut;
ALTER TABLE llx_projet
    ADD COLUMN opp_amount double(24, 8) DEFAULT NULL;
...
ALTER TABLE llx_commande_fournisseur
    ADD COLUMN date_approve2 datetime AFTER date_approve;
ALTER TABLE llx_commande_fournisseur
    ADD COLUMN fk_user_approve2 integer AFTER fk_user_approve;

ALTER TABLE llx_societe
    ADD COLUMN fk_incoterms integer;
ALTER TABLE llx_societe
    ADD COLUMN location_incoterms varchar(255);
...
INSERT INTO llx_c_incoterms (code, libelle, active)
VALUES ('EXW',
        'Ex Works, au départ non chargé, non dédouané sortie d''usine (uniquement adapté aux flux domestiques, nationaux)',
        1);
INSERT INTO llx_c_incoterms (code, libelle, active)
VALUES ('FCA',
        'Free Carrier, marchandises dédouanées et chargées dans le pays de départ, chez le vendeur ou chez le commissionnaire de transport de l''acheteur',
        1);
INSERT INTO llx_c_incoterms (code, libelle, active)
VALUES ('FAS', 'Free Alongside Ship, sur le quai du port de départ', 1);
INSERT INTO llx_c_incoterms (code, libelle, active)
VALUES ('FOB',
        'Free On Board, chargé sur le bateau, les frais de chargement dans celui-ci étant fonction du liner term indiqué par la compagnie maritime (à la charge du vendeur)',
        1);
INSERT INTO llx_c_incoterms (code, libelle, active)
VALUES ('CFR',
        'Cost and Freight, chargé dans le bateau, livraison au port de départ, frais payés jusqu''au port d''arrivée, sans assurance pour le transport, non déchargé du navire à destination (les frais de déchargement sont inclus ou non au port d''arrivée)',
        1);
INSERT INTO llx_c_incoterms (code, libelle, active)
VALUES ('CIF',
        'Cost, Insurance and Freight, chargé sur le bateau, frais jusqu''au port d''arrivée, avec l''assurance marchandise transportée souscrite par le vendeur pour le compte de l''acheteur',
        1);
INSERT INTO llx_c_incoterms (code, libelle, active)
VALUES ('CPT',
        'Carriage Paid To, livraison au premier transporteur, frais jusqu''au déchargement du mode de transport, sans assurance pour le transport',
        1);
INSERT INTO llx_c_incoterms (code, libelle, active)
VALUES ('CIP',
        'Carriage and Insurance Paid to, idem CPT, avec assurance marchandise transportée souscrite par le vendeur pour le compte de l''acheteur',
        1);
INSERT INTO llx_c_incoterms (code, libelle, active)
VALUES ('DAT',
        'Delivered At Terminal, marchandises (déchargées) livrées sur quai, dans un terminal maritime, fluvial, aérien, routier ou ferroviaire désigné (dédouanement import, et post-acheminement payés par l''acheteur)',
        1);
INSERT INTO llx_c_incoterms (code, libelle, active)
VALUES ('DAP',
        'Delivered At Place, marchandises (non déchargées) mises à disposition de l''acheteur dans le pays d''importation au lieu précisé dans le contrat (déchargement, dédouanement import payé par l''acheteur)',
        1);
INSERT INTO llx_c_incoterms (code, libelle, active)
VALUES ('DDP',
        'Delivered Duty Paid, marchandises (non déchargées) livrées à destination finale, dédouanement import et taxes à la charge du vendeur ; l''acheteur prend en charge uniquement le déchargement (si exclusion des taxes type TVA, le préciser clairement)',
        1);
...
ALTER TABLE llx_societe_extrafields
    ADD UNIQUE INDEX uk_societe_extrafields (fk_object);

-- Module Donation
ALTER TABLE llx_don
    ADD COLUMN fk_country integer NOT NULL DEFAULT 0 AFTER country;
ALTER TABLE llx_don CHANGE COLUMN fk_paiement fk_payment integer;
ALTER TABLE llx_don
    ADD COLUMN paid smallint DEFAULT 0 NOT NULL AFTER fk_payment;
...
ALTER TABLE llx_don_extrafields
    ADD INDEX idx_don_extrafields (fk_object);
...
VALUES ('ORDER_SENTBYMAIL', 'Customer order sent by mail', 'Executed when a customer order is sent by mail ',
        'commande', 5);
INSERT INTO llx_c_action_trigger (code, label, description, elementtype, rang)
VALUES ('BILL_PAYED', 'Customer invoice paid', 'Executed when a customer invoice is paid', 'facture', 7);
INSERT INTO llx_c_action_trigger (code, label, description, elementtype, rang)
VALUES ('BILL_CANCEL', 'Customer invoice canceled', 'Executed when a customer invoice is conceled', 'facture', 8);
INSERT INTO llx_c_action_trigger (code, label, description, elementtype, rang)
...
VALUES ('BILL_SUPPLIER_VALIDATE', 'Supplier invoice validated', 'Executed when a supplier invoice is validated',
        'invoice_supplier', 15);
INSERT INTO llx_c_action_trigger (code, label, description, elementtype, rang)
VALUES ('BILL_SUPPLIER_PAYED', 'Supplier invoice paid', 'Executed when a supplier invoice is paid', 'invoice_supplier',
        16);
INSERT INTO llx_c_action_trigger (code, label, description, elementtype, rang)
...
INSERT INTO llx_c_action_trigger (code, label, description, elementtype, rang)
VALUES ('MEMBER_SUBSCRIPTION', 'Member subscribed', 'Executed when a member is subscribed', 'member', 23);
INSERT INTO llx_c_action_trigger (code, label, description, elementtype, rang)
VALUES ('MEMBER_RESILIATE', 'Member resiliated', 'Executed when a member is resiliated', 'member', 24);
INSERT INTO llx_c_action_trigger (code, label, description, elementtype, rang)
VALUES ('MEMBER_MODIFY', 'Member modified', 'Executed when a member is modified', 'member', 24);
INSERT INTO llx_c_action_trigger (code, label, description, elementtype, rang)
VALUES ('MEMBER_DELETE', 'Member deleted', 'Executed when a member is deleted', 'member', 25);
INSERT INTO llx_c_action_trigger (code, label, description, elementtype, rang)
VALUES ('BILL_UNVALIDATE', 'Customer invoice unvalidated', 'Executed when a customer invoice status set back to draft',
        'facture', 10);
INSERT INTO llx_c_action_trigger (code, label, description, elementtype, rang)
VALUES ('FICHINTER_VALIDATE', 'Intervention validated', 'Executed when a intervention is validated', 'ficheinter', 19);
INSERT INTO llx_c_action_trigger (code, label, description, elementtype, rang)
...
VALUES ('FICHINTER_SENTBYMAIL', 'Intervention sent by mail', 'Executed when a intervention is sent by mail',
        'ficheinter', 19);
INSERT INTO llx_c_action_trigger (code, label, description, elementtype, rang)
VALUES ('PROJECT_CREATE', 'Project creation', 'Executed when a project is created', 'project', 30);
INSERT INTO llx_c_action_trigger (code, label, description, elementtype, rang)
...
VALUES ('PROPAL_CLASSIFY_BILLED', 'Customer proposal set billed', 'Executed when a customer proposal is set to billed',
        'propal', 2);
INSERT INTO llx_c_action_trigger (code, label, description, elementtype, rang)
VALUES ('TASK_CREATE', 'Task created', 'Executed when a project task is created', 'project', 35);
INSERT INTO llx_c_action_trigger (code, label, description, elementtype, rang)
VALUES ('TASK_MODIFY', 'Task modified', 'Executed when a project task is modified', 'project', 36);
INSERT INTO llx_c_action_trigger (code, label, description, elementtype, rang)
VALUES ('TASK_DELETE', 'Task deleted', 'Executed when a project task is deleted', 'project', 37);
...
ALTER TABLE llx_adherent
    ADD COLUMN note_public text DEFAULT NULL AFTER note_private;
...
INSERT INTO llx_c_units (code, label, short_label, active)
VALUES ('P', 'piece', 'p', 1);
INSERT INTO llx_c_units (code, label, short_label, active)
VALUES ('SET', 'set', 'se', 1);
INSERT INTO llx_c_units (code, label, short_label, active)
...
VALUES ('D', 'day', 'd', 1);
INSERT INTO llx_c_units (code, label, short_label, active)
VALUES ('KG', 'kilogram', 'kg', 1);
INSERT INTO llx_c_units (code, label, short_label, active)
VALUES ('G', 'gram', 'g', 1);
INSERT INTO llx_c_units (code, label, short_label, active)
VALUES ('M', 'meter', 'm', 1);
INSERT INTO llx_c_units (code, label, short_label, active)
VALUES ('LM', 'linear meter', 'lm', 1);
INSERT INTO llx_c_units (code, label, short_label, active)
VALUES ('M2', 'square meter', 'm2', 1);
INSERT INTO llx_c_units (code, label, short_label, active)
VALUES ('M3', 'cubic meter', 'm3', 1);
INSERT INTO llx_c_units (code, label, short_label, active)
VALUES ('L', 'liter', 'l', 1);

alter table llx_product
    add fk_unit integer DEFAULT NULL;
ALTER TABLE llx_product
...
ALTER TABLE llx_user
    ADD INDEX idx_user_fk_societe (fk_soc);
...
-- API module
ALTER TABLE llx_user
    ADD api_key VARCHAR(128) DEFAULT NULL AFTER pass_temp;
ALTER TABLE llx_user
    ADD INDEX idx_user_api_key (api_key);
...
ALTER TABLE llx_actioncomm
    ADD COLUMN email_msgid varchar(255);
ALTER TABLE llx_actioncomm
...
ALTER TABLE llx_actioncomm
    ADD COLUMN errors_to varchar(255);

-- Recurring events
ALTER TABLE llx_actioncomm
    ADD COLUMN recurid varchar(128);
ALTER TABLE llx_actioncomm
    ADD COLUMN recurrule varchar(128);
ALTER TABLE llx_actioncomm
    ADD COLUMN recurdateend datetime;

ALTER TABLE llx_c_stcomm
    ADD COLUMN picto varchar(128);
...
ALTER TABLE llx_c_holiday_types
    ADD UNIQUE INDEX uk_c_holiday_types (code);

INSERT INTO llx_c_holiday_types(code, label, affect, delay, newByMonth, fk_country)
VALUES ('LEAVE_PAID', 'Paid vacation', 1, 7, 0, NULL);
INSERT INTO llx_c_holiday_types(code, label, affect, delay, newByMonth, fk_country)
VALUES ('LEAVE_SICK', 'Sick leave', 0, 0, 0, NULL);
INSERT INTO llx_c_holiday_types(code, label, affect, delay, newByMonth, fk_country)
VALUES ('LEAVE_OTHER', 'Other leave', 0, 0, 0, NULL);
-- Leaves specific to France
INSERT INTO llx_c_holiday_types(code, label, affect, delay, newByMonth, fk_country)
VALUES ('LEAVE_RTT', 'RTT', 1, 7, 0.83, 1);

ALTER TABLE llx_holiday
    ADD COLUMN fk_type integer NOT NULL DEFAULT 1;
ALTER TABLE llx_holiday_users
    ADD COLUMN fk_type integer NOT NULL DEFAULT 1;
ALTER TABLE llx_holiday_logs
    ADD COLUMN fk_type integer NOT NULL DEFAULT 1;

UPDATE llx_holiday_users
SET fk_type = 1
WHERE fk_type IS NULL;
UPDATE llx_holiday_logs
SET fk_type = 1
WHERE fk_type IS NULL;

UPDATE llx_const
SET name = __ENCRYPT('ACCOUNTING_VAT_SOLD_ACCOUNT') __
WHERE __DECRYPT('name') __ = 'ACCOUNTING_VAT_ACCOUNT';
...
INSERT INTO llx_c_lead_status(rowid, code, label, position, percent, active)
VALUES (1, 'PROSP', 'Prospection', 10, 0, 1);
INSERT INTO llx_c_lead_status(rowid, code, label, position, percent, active)
VALUES (2, 'QUAL', 'Qualification', 20, 20, 1);
INSERT INTO llx_c_lead_status(rowid, code, label, position, percent, active)
VALUES (3, 'PROPO', 'Proposal', 30, 40, 1);
INSERT INTO llx_c_lead_status(rowid, code, label, position, percent, active)
VALUES (4, 'NEGO', 'Negotiation', 40, 60, 1);
INSERT INTO llx_c_lead_status(rowid, code, label, position, percent, active)
VALUES (5, 'PENDING', 'Pending', 50, 50, 0);
INSERT INTO llx_c_lead_status(rowid, code, label, position, percent, active)
VALUES (6, 'WON', 'Won', 60, 100, 1);
INSERT INTO llx_c_lead_status(rowid, code, label, position, percent, active)
VALUES (7, 'LOST', 'Lost', 70, 0, 1);


DELETE
FROM llx_c_action_trigger
where code = 'PROPAL_CLASSIFYBILLED';
DELETE
FROM llx_c_action_trigger
where code = 'FICHINTER_CLASSIFYBILLED';

-- Spain provinces to ISO codes
UPDATE llx_c_departements
SET code_departement='VI'
WHERE ncc = 'ALAVA'
  AND fk_region = 419;
UPDATE llx_c_departements
SET code_departement='AB'
WHERE ncc = 'ALBACETE'
  AND fk_region = 404;
UPDATE llx_c_departements
SET code_departement='A'
WHERE ncc = 'ALICANTE'
  AND fk_region = 411;
UPDATE llx_c_departements
SET code_departement='AL'
WHERE ncc = 'ALMERIA'
  AND fk_region = 401;
UPDATE llx_c_departements
SET code_departement='AV'
WHERE ncc = 'AVILA'
  AND fk_region = 403;
UPDATE llx_c_departements
SET code_departement='BA'
WHERE ncc = 'BADAJOZ'
  AND fk_region = 412;
UPDATE llx_c_departements
SET code_departement='PM'
WHERE ncc = 'ISLAS BALEARES'
  AND fk_region = 414;
UPDATE llx_c_departements
SET code_departement='B'
WHERE ncc = 'BARCELONA'
  AND fk_region = 406;
UPDATE llx_c_departements
SET code_departement='BU'
WHERE ncc = 'BURGOS'
  AND fk_region = 403;
UPDATE llx_c_departements
SET code_departement='CC'
WHERE ncc = 'CACERES'
  AND fk_region = 412;
UPDATE llx_c_departements
SET code_departement='CA'
WHERE ncc = 'CADIZ'
  AND fk_region = 401;
UPDATE llx_c_departements
SET code_departement='CS'
WHERE ncc = 'CASTELLON'
  AND fk_region = 411;
UPDATE llx_c_departements
SET code_departement='CR'
WHERE ncc = 'CIUDAD REAL'
  AND fk_region = 404;
UPDATE llx_c_departements
SET code_departement='CO'
WHERE ncc = 'CORDOBA'
  AND fk_region = 401;
UPDATE llx_c_departements
SET code_departement='C'
WHERE ncc = 'LA CORUÑA'
  AND fk_region = 413;
UPDATE llx_c_departements
SET code_departement='CU'
WHERE ncc = 'CUENCA'
  AND fk_region = 404;
UPDATE llx_c_departements
SET code_departement='GI'
WHERE ncc = 'GERONA'
  AND fk_region = 406;
UPDATE llx_c_departements
SET code_departement='GR'
WHERE ncc = 'GRANADA'
  AND fk_region = 401;
UPDATE llx_c_departements
SET code_departement='GU'
WHERE ncc = 'GUADALAJARA'
  AND fk_region = 404;
UPDATE llx_c_departements
SET code_departement='SS'
WHERE ncc = 'GUIPUZCOA'
  AND fk_region = 419;
UPDATE llx_c_departements
SET code_departement='H'
WHERE ncc = 'HUELVA'
  AND fk_region = 401;
UPDATE llx_c_departements
SET code_departement='HU'
WHERE ncc = 'HUESCA'
  AND fk_region = 402;
UPDATE llx_c_departements
SET code_departement='J'
WHERE ncc = 'JAEN'
  AND fk_region = 401;
UPDATE llx_c_departements
SET code_departement='LE'
WHERE ncc = 'LEON'
  AND fk_region = 403;
UPDATE llx_c_departements
SET code_departement='L'
WHERE ncc = 'LERIDA'
  AND fk_region = 406;
UPDATE llx_c_departements
SET code_departement='LO'
WHERE ncc = 'LA RIOJA'
  AND fk_region = 415;
UPDATE llx_c_departements
SET code_departement='LU'
WHERE ncc = 'LUGO'
  AND fk_region = 413;
UPDATE llx_c_departements
SET code_departement='M'
WHERE ncc = 'MADRID'
  AND fk_region = 416;
UPDATE llx_c_departements
SET code_departement='MA'
WHERE ncc = 'MALAGA'
  AND fk_region = 401;
UPDATE llx_c_departements
SET code_departement='MU'
WHERE ncc = 'MURCIA'
  AND fk_region = 417;
UPDATE llx_c_departements
SET code_departement='NA'
WHERE ncc = 'NAVARRA'
  AND fk_region = 408;
UPDATE llx_c_departements
SET code_departement='OR'
WHERE ncc = 'ORENSE'
  AND fk_region = 413;
UPDATE llx_c_departements
SET code_departement='VI'
WHERE ncc = 'ALAVA'
  AND fk_region = 419;
UPDATE llx_c_departements
SET code_departement='O'
WHERE ncc = 'ASTURIAS'
  AND fk_region = 418;
UPDATE llx_c_departements
SET code_departement='P'
WHERE ncc = 'PALENCIA'
  AND fk_region = 403;
UPDATE llx_c_departements
SET code_departement='GC'
WHERE ncc = 'LAS PALMAS'
  AND fk_region = 405;
UPDATE llx_c_departements
SET code_departement='PO'
WHERE ncc = 'PONTEVEDRA'
  AND fk_region = 413;
UPDATE llx_c_departements
SET code_departement='SA'
WHERE ncc = 'SALAMANCA'
  AND fk_region = 403;
UPDATE llx_c_departements
SET code_departement='TF'
WHERE ncc = 'STA. CRUZ DE TENERIFE'
  AND fk_region = 405;
UPDATE llx_c_departements
SET code_departement='S'
WHERE ncc = 'CANTABRIA'
  AND fk_region = 410;
UPDATE llx_c_departements
SET code_departement='SG'
WHERE ncc = 'SEGOVIA'
  AND fk_region = 403;
UPDATE llx_c_departements
SET code_departement='SE'
WHERE ncc = 'SEVILLA'
  AND fk_region = 401;
UPDATE llx_c_departements
SET code_departement='SO'
WHERE ncc = 'SORIA'
  AND fk_region = 403;
UPDATE llx_c_departements
SET code_departement='T'
WHERE ncc = 'TARRAGONA'
  AND fk_region = 406;
UPDATE llx_c_departements
SET code_departement='TE'
WHERE ncc = 'TERUEL'
  AND fk_region = 402;
UPDATE llx_c_departements
SET code_departement='TO'
WHERE ncc = 'TOLEDO'
  AND fk_region = 404;
UPDATE llx_c_departements
SET code_departement='V'
WHERE ncc = 'VALENCIA'
  AND fk_region = 411;
UPDATE llx_c_departements
SET code_departement='VA'
WHERE ncc = 'VALLADOLID'
  AND fk_region = 403;
UPDATE llx_c_departements
SET code_departement='BI'
WHERE ncc = 'VIZCAYA'
  AND fk_region = 419;
UPDATE llx_c_departements
SET code_departement='ZA'
WHERE ncc = 'ZAMORA'
  AND fk_region = 403;
UPDATE llx_c_departements
SET code_departement='Z'
WHERE ncc = 'ZARAGOZA'
  AND fk_region = 402;
UPDATE llx_c_departements
SET code_departement='VI'
WHERE ncc = 'ALAVA'
  AND fk_region = 419;
UPDATE llx_c_departements
SET code_departement='CE'
WHERE ncc = 'CEUTA'
  AND fk_region = 407;
UPDATE llx_c_departements
SET code_departement='ML'
WHERE ncc = 'MELILLA'
  AND fk_region = 409;
DELETE

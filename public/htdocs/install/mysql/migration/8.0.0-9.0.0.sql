...
ALTER TABLE llx_contrat_extrafields
    ADD INDEX idx_contrat_extrafields (fk_object);
...
ALTER TABLE llx_extrafields
    ADD COLUMN help text NULL;
ALTER TABLE llx_extrafields
    ADD COLUMN totalizable boolean DEFAULT FALSE after list;
ALTER TABLE llx_product_fournisseur_price
    ADD COLUMN desc_fourn text after ref_fourn;


ALTER TABLE llx_user
    ADD COLUMN dateemploymentend date after dateemployment;
...
insert into llx_c_action_trigger (code, label, description, elementtype, rang)
values ('EXPENSE_DELETE', 'Expense report deleted', 'Executed when an expense report is deleted', 'expensereport', 204);
insert into llx_c_action_trigger (code, label, description, elementtype, rang)
...
ALTER TABLE llx_payment_salary
    ADD COLUMN ref varchar(30) NULL after rowid;
ALTER TABLE llx_payment_salary
    ADD COLUMN fk_projet integer DEFAULT NULL after amount;
...
ALTER TABLE llx_paiement
    ADD COLUMN ext_payment_id varchar(128);
ALTER TABLE llx_paiement
    ADD COLUMN ext_payment_site varchar(128);

ALTER TABLE llx_societe
    ADD COLUMN twitter varchar(255) after skype;
ALTER TABLE llx_societe
    ADD COLUMN facebook varchar(255) after skype;
ALTER TABLE llx_societe
    ADD COLUMN instagram varchar(255) after skype;
ALTER TABLE llx_societe
    ADD COLUMN snapchat varchar(255) after skype;
ALTER TABLE llx_societe
    ADD COLUMN googleplus varchar(255) after skype;
ALTER TABLE llx_societe
    ADD COLUMN youtube varchar(255) after skype;
ALTER TABLE llx_societe
    ADD COLUMN whatsapp varchar(255) after skype;
...
ALTER TABLE llx_adherent
    ADD COLUMN snapchat varchar(255);
ALTER TABLE llx_adherent
    ADD COLUMN googleplus varchar(255);
ALTER TABLE llx_adherent
...
ALTER TABLE llx_website
    ADD COLUMN maincolor varchar(16);
ALTER TABLE llx_website
    ADD COLUMN maincolorbis varchar(16);
...
UPDATE llx_c_payment_term
SET decalage = nbjour,
    nbjour   = 0
where decalage IS NULL
  AND type_cdr = 2;
...
ALTER TABLE llx_emailcollector_emailcollector
    ADD INDEX idx_emailcollector_entity (entity);
ALTER TABLE llx_emailcollector_emailcollector
    ADD INDEX idx_emailcollector_status (status);
...
ALTER TABLE llx_emailcollector_emailcollectorfilter
    ADD UNIQUE INDEX uk_emailcollector_emailcollectorfilter (fk_emailcollector, type, rulevalue);
ALTER TABLE llx_emailcollector_emailcollectoraction
...
ALTER TABLE llx_societe_rib
    ADD COLUMN ipaddress varchar(68);
...
UPDATE llx_const
set name = __ENCRYPT('PRELEVEMENT_END_TO_END') __
where name = __ENCRYPT('END_TO_END') __;
UPDATE llx_const
set name = __ENCRYPT('PRELEVEMENT_USTRD') __
where name = __ENCRYPT('USTRD') __;

...
INSERT INTO llx_c_type_fees (code, label, active)
VALUES ('EX_KME', 'ExpLabelKm', 1);
INSERT INTO llx_c_type_fees (code, label, active)
VALUES ('EX_FUE', 'ExpLabelFuelCV', 0);
INSERT INTO llx_c_type_fees (code, label, active)
VALUES ('EX_HOT', 'ExpLabelHotel', 0);
INSERT INTO llx_c_type_fees (code, label, active)
VALUES ('EX_PAR', 'ExpLabelParkingCV', 0);
INSERT INTO llx_c_type_fees (code, label, active)
VALUES ('EX_TOL', 'ExpLabelTollCV', 0);
INSERT INTO llx_c_type_fees (code, label, active)
VALUES ('EX_TAX', 'ExpLabelVariousTaxes', 0);
INSERT INTO llx_c_type_fees (code, label, active)
VALUES ('EX_IND', 'ExpLabelIndemnityTransSubscrip', 0);
INSERT INTO llx_c_type_fees (code, label, active)
VALUES ('EX_SUM', 'ExpLabelMaintenanceSupply', 0);
INSERT INTO llx_c_type_fees (code, label, active)
VALUES ('EX_SUO', 'ExpLabelOfficeSupplies', 0);
INSERT INTO llx_c_type_fees (code, label, active)
VALUES ('EX_CAR', 'ExpLabelCarRental', 0);
INSERT INTO llx_c_type_fees (code, label, active)
VALUES ('EX_DOC', 'ExpLabelDocumentation', 0);
INSERT INTO llx_c_type_fees (code, label, active)
VALUES ('EX_CUR', 'ExpLabelCustomersReceiving', 0);
INSERT INTO llx_c_type_fees (code, label, active)
VALUES ('EX_OTR', 'ExpLabelOtherReceiving', 0);
INSERT INTO llx_c_type_fees (code, label, active)
VALUES ('EX_POS', 'ExpLabelPostage', 0);
INSERT INTO llx_c_type_fees (code, label, active)
VALUES ('EX_CAM', 'ExpLabelMaintenanceRepairCV', 0);
INSERT INTO llx_c_type_fees (code, label, active)
VALUES ('EX_EMM', 'ExpLabelEmployeesMeal', 0);
INSERT INTO llx_c_type_fees (code, label, active)
VALUES ('EX_GUM', 'ExpLabelGuestsMeal', 0);
INSERT INTO llx_c_type_fees (code, label, active)
VALUES ('EX_BRE', 'ExpLabelBreakfast', 0);
INSERT INTO llx_c_type_fees (code, label, active)
VALUES ('EX_FUE_VP', 'ExpLabelFuelPV', 0);
INSERT INTO llx_c_type_fees (code, label, active)
VALUES ('EX_TOL_VP', 'ExpLabelTollPV', 0);
INSERT INTO llx_c_type_fees (code, label, active)
VALUES ('EX_PAR_VP', 'ExpLabelParkingPV', 0);
INSERT INTO llx_c_type_fees (code, label, active)
VALUES ('EX_CAM_VP', 'ExpLabelMaintenanceRepairPV', 0);

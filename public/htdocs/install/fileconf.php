        ...
        <table class="nobordernopadding<?php if ($force_install_noedit) {
            ...
            <tr>
                <td colspan="3" class="label">
                    <h3><img class="valignmiddle inline-block paddingright"
                             src="<?= constant('DOL_URL_ROOT') ?>/theme/common/octicons/build/svg/globe.svg" width="20"
                             alt="webserver"> <?php echo $langs->trans("WebServer"); ?></h3>
                </td>
            </tr>
            ...
            <tr>
                <td class="label"><label
                            for="main_dir"><b><?php print $langs->trans("WebPagesDirectory"); ?></b></label></td>
                <?php
            ...
            <tr>
                <td class="label"><label for="main_data_dir"><b><?php print $langs->trans("DocumentsDirectory"); ?></b></label>
                </td>
                <?php
            ...
            */
            ...
            if (!empty($_SERVER["HTTPS"]) && $_SERVER["HTTPS"] == 'on') {   // Enabled if the installation process is "https://"
                ?>
                <tr>
                    <td class="label"><label for="main_force_https"><?php echo $langs->trans("ForceHttps"); ?></label>
                    </td>
                    <td class="label">
                        <input type="checkbox"
                               id="main_force_https"
            ...
            <tr>
                <td colspan="3" class="label"><br>
                    <h3><img class="valignmiddle inline-block paddingright"
                             src="<?= constant('DOL_URL_ROOT') ?>/theme/common/octicons/build/svg/database.svg"
                             width="20" alt="webserver"> <?php echo $langs->trans("DolibarrDatabase"); ?></h3>
                </td>
            </tr>
            ...
            <tr class="hidesqlite">
                ...
                <td class="label">
                    <input type="text"
                           id="db_prefix"
                           name="db_prefix"
                           value="<?php echo(!empty($force_install_prefix) ? $force_install_prefix : (!empty($dolibarr_main_db_prefix) ? $dolibarr_main_db_prefix : constant('DEFAULT_DB_PREFIX'))); ?>"
            ...
            <tr class="hidesqlite">
                <td class="label"><label for="db_create_database"><?php echo $langs->trans("CreateDatabase"); ?></label>
                </td>
                <td class="label">
                    <input type="checkbox"
            ...
            <tr class="hidesqlite hideroot">
                <td colspan="3" class="label"><br>
                    <h3><img class="valignmiddle inline-block paddingright"
                             src="<?= constant('DOL_URL_ROOT') ?>/theme/common/octicons/build/svg/shield.svg" width="20"
                             alt="webserver"> <?php echo $langs->trans("DatabaseSuperUserAccess"); ?></h3>
                </td>
            </tr>

...
if (isModEnabled('holiday') && $user->hasRight('holiday', 'read')) {
    ...
    if ($result) {
        ...
        print '<a href="' . constant('BASE_URL') . '/holiday/list.php?sortfield=cp.tms&sortorder=DESC" title="' . $langs->trans("FullList") . '">';
...
if (isModEnabled('expensereport') && $user->hasRight('expensereport', 'read')) {
    ...
    if ($result) {
        ...
        print '<a href="' . constant('BASE_URL') . '/expensereport/list.php?sortfield=d.tms&sortorder=DESC" title="' . $langs->trans("FullList") . '">';
        print '<span class="badge marginleftonlyshort">...</span>';
...
if (isModEnabled('recruitment') && $user->hasRight('recruitment', 'recruitmentjobposition', 'read')) {
    ...
    if ($resql) {
        ...
        print '<a href="' . constant('BASE_URL') . '/recruitment/recruitmentcandidature_list.php?sortfield=t.tms&sortorder=DESC" title="' . $langs->trans("FullList") . '">';
        print '<span class="badge marginleftonlyshort">...</span>';

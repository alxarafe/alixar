...
if ($resql) {
    ...
    print '<a href="' . constant('BASE_URL') . 'expedition/list.php?search_status=' . Expedition::STATUS_DRAFT . '">';
    ...
    if ($num) {
        ...
        while ($i < $num) {
            ...
            print "</td>";
            print '<td>';
            print '<a href="' . constant('BASE_URL') . 'comm/card.php?socid=' . $obj->socid . '">' . $obj->name . '</a>';
            print '</td>';
            print '<td>';
            if ($obj->commande_id) {
                print '<a href="' . constant('BASE_URL') . 'commande/card.php?id=' . $obj->commande_id . '">' . $obj->commande_ref . '</a>';
            }
            print '</td></tr>';
            $i++;
        }
...
if ($resql) {
    ...
    print '<a href="' . constant('BASE_URL') . 'expedition/list.php?search_status=' . Expedition::STATUS_VALIDATED . '">';
    print '<span class="badge">' . $num . '</span>';
    print '</a>';
    print '</th>';
    print '</tr>';
    ...
    if ($num) {
        ...
        while ($i < $num) {
            ...
            print $shipment->getNomUrl(1);
            print '</td>';
            print '<td><a href="' . constant('BASE_URL') . 'comm/card.php?socid=' . $obj->socid . '">' . img_object($langs->trans("ShowCompany"), "company") . ' ' . $obj->name . '</a></td>';
            print '<td>';
...
if ($resql) {
    ...
    print '<a href="' . constant('BASE_URL') . 'commande/list.php?search_status=' . Commande::STATUS_VALIDATED . ',' . Commande::STATUS_ACCEPTED . '">';
    print '<span class="badge">' . $num . '</span>';
    print '</a>';
    print '</th>';
    print '</tr>';

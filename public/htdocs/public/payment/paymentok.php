...
if (isModEnabled('paypal')) {
    ...
    require_once constant('DOL_DOCUMENT_ROOT') . '/paypal/lib/paypalfunctions.lib.php';
}
...
if (!empty($doactionsthenredirect)) {
    if ($ispaymentok) {
        ...
        $ext_urlok = constant('BASE_URL') . '/public/website/index.php?website=' . urlencode($ws) . '&pageref=paymentok&fulltag=' . $FULLTAG;
        ...
        $ext_urlko = constant('BASE_URL') . '/public/website/index.php?website=' . urlencode($ws) . '&pageref=paymentko&fulltag=' . $FULLTAG;

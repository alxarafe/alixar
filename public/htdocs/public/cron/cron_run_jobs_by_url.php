    ...
    foreach ($object->lines as $line) {
        ...
        if ($datenextrunok && $datestartok && $dateendok) {
            ...
            if ($result < 0) {
                ...
                echo "You can also enable module Log if not yet enabled, run again and take a look into alixar.log file\n";
            ...
            if ($result < 0) {
                ...
                echo "Enable module Log if not yet enabled, run again and take a look into alixar.log file\n";

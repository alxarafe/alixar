...
if ($resql) {
    ...
    $lastmodified = '<a href="' . constant('BASE_URL') . '/bom/bom_list.php?sortfield=t.tms&sortorder=DESC" title="' . $langs->trans("FullList") . '">';
...
if ($resql) {
    ...
    $lastmodified = '<a href="' . constant('BASE_URL') . '/mrp/mo_list.php?sortfield=t.tms&sortorder=DESC" title="' . $langs->trans("FullList") . '">';
    $lastmodified .= '<span class="badge marginleftonlyshort">...</span>';
    $lastmodified .= '</a>';
    print $lastmodified;
    print '</th>';

...
if (!$user->hasRight('societe', 'client', 'voir')) {
    ...
    if ($mode == 'customer') {
        $fileurlnb = constant('BASE_URL') . '/viewimage.php?modulepart=orderstats&file=ordersnbinyear-' . $user->id . '-' . $year . '.png';
    }
    if ($mode == 'supplier') {
        $fileurlnb = constant('BASE_URL') . '/viewimage.php?modulepart=orderstatssupplier&file=ordersnbinyear-' . $user->id . '-' . $year . '.png';
    }
} else {
    $filenamenb = $dir . '/ordersnbinyear-' . $year . '.png';
    if ($mode == 'customer') {
        $fileurlnb = constant('BASE_URL') . '/viewimage.php?modulepart=orderstats&file=ordersnbinyear-' . $year . '.png';
    }
    if ($mode == 'supplier') {
        $fileurlnb = constant('BASE_URL') . '/viewimage.php?modulepart=orderstatssupplier&file=ordersnbinyear-' . $year . '.png';
    }
}
...
if (!$user->hasRight('societe', 'client', 'voir')) {
    ...
    if ($mode == 'customer') {
        $fileurlamount = constant('BASE_URL') . '/viewimage.php?modulepart=orderstats&file=ordersamountinyear-' . $user->id . '-' . $year . '.png';
    }
    if ($mode == 'supplier') {
        $fileurlamount = constant('BASE_URL') . '/viewimage.php?modulepart=orderstatssupplier&file=ordersamountinyear-' . $user->id . '-' . $year . '.png';
    }
} else {
    $filenameamount = $dir . '/ordersamountinyear-' . $year . '.png';
    if ($mode == 'customer') {
        $fileurlamount = constant('BASE_URL') . '/viewimage.php?modulepart=orderstats&file=ordersamountinyear-' . $year . '.png';
    }
    if ($mode == 'supplier') {
        $fileurlamount = constant('BASE_URL') . '/viewimage.php?modulepart=orderstatssupplier&file=ordersamountinyear-' . $year . '.png';
    }
}
...
$h = 0;
$head = array();
$head[$h][0] = constant('BASE_URL') . '/commande/stats/index.php?mode=' . $mode;

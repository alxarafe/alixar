...
function recruitmentjobpositionPrepareHead($object)
{
    ...
    $head[$h][0] = constant('BASE_URL') . '/recruitment/recruitmentjobposition_card.php?id=' . $object->id;
    $head[$h][1] = $langs->trans("PositionToBeFilled");
    $head[$h][2] = 'card';
    $h++;

    $head[$h][0] = constant('BASE_URL') . '/recruitment/recruitmentcandidature_list.php?id=' . $object->id;
    ...
    if (isset($object->fields['note_public']) || isset($object->fields['note_private'])) {
        ...
        $head[$h][0] = constant('BASE_URL') . '/recruitment/recruitmentjobposition_note.php?id=' . $object->id;
    ...
    $head[$h][0] = constant('BASE_URL') . '/recruitment/recruitmentjobposition_document.php?id=' . $object->id;
    ...
    $head[$h][0] = constant('BASE_URL') . '/recruitment/recruitmentjobposition_agenda.php?id=' . $object->id;

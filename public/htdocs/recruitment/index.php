...
if (isModEnabled('recruitment') && $user->hasRight('recruitment', 'recruitmentjobposition', 'read')) {
    ...
    if ($resql) {
        ...
        print '</th>';
        print '<th class="right" colspan="2"><a href="' . constant('BASE_URL') . '/recruitment/recruitmentjobposition_list.php?sortfield=t.tms&sortorder=DESC">' . $langs->trans("FullList") . '</th>';
        print '</tr>';
        if ($num) {
            while ($i < $num) {
...
if (isModEnabled('recruitment') && $user->hasRight('recruitment', 'recruitmentjobposition', 'read')) {
    ...
    if ($resql) {
        ...
        print '</th>';
        print '<th class="right" colspan="2"><a href="' . constant('BASE_URL') . '/recruitment/recruitmentcandidature_list.php?sortfield=t.tms&sortorder=DESC">' . $langs->trans("FullList") . '</th>';
        print '</tr>';
        if ($num) {
            while ($i < $num) {
                $objp = $db->fetch_object($resql);

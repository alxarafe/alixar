...
ViewMain::llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-user page-card_param_ihm');
...
if ($action == 'edit') {
    ...
    if (!empty($object->conf->MAIN_LANDING_PAGE)) {
        ...
        print '<a href="' . constant('BASE_URL') . '/' . $object->conf->MAIN_LANDING_PAGE . '" target="_blank" rel="noopener">';
        $s = '';

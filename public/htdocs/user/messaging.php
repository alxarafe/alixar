...
$help_url = '';
ViewMain::llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-user page-messaging');
...
$messagingUrl = constant('BASE_URL') . '/user/messaging.php?userid=' . $object->id;
$morehtmlright .= dolGetButtonTitle($langs->trans('ShowAsConversation'), '', 'fa fa-comments imgforviewmode', $messagingUrl, '', 2);
$messagingUrl = constant('BASE_URL') . '/user/agenda.php?id=' . $object->id;

...
if ($resql) {
    ...
    $lastcreatedbox .= '<a class="valignmiddle marginleftonlyshort" href="' . constant('BASE_URL') . '/user/list.php?sortfield=u.datec&sortorder=DESC" title="' . $langs->trans("FullList") . '">';
...
if ($canreadperms) {
    ...
    if ($resql) {
        ...
        $lastgroupbox .= '<a class="valignmiddle marginleftonlyshort" href="' . constant('BASE_URL') . '/user/group/list.php?sortfield=g.datec&sortorder=DESC" title="' . $langs->trans("FullList") . '">';

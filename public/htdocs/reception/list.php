...
$newcardbutton .= dolGetButtonTitle($langs->trans('NewReception'), '', 'fa fa-plus-circle', constant('BASE_URL') . '/reception/card.php?action=create2', '', $user->hasRight('reception', 'creer'));

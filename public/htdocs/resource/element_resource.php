...
if (!$ret) {
    ...
    if (($element_id || $element_ref) && $element == 'action') {
        ...
        if (is_object($act)) {
            ...
            $out .= '<a href="' . constant('BASE_URL') . '/comm/action/index.php?mode=show_month&year=' . dol_print_date($act->datep, '%Y') . '&month=' . dol_print_date($act->datep, '%m') . '&day=' . dol_print_date($act->datep, '%d') . '">';
            ...
            $out .= '</a>';
            $out .= '</li><li class="noborder litext">';
            $out .= '<a href="' . constant('BASE_URL') . '/comm/action/index.php?mode=show_day&year=' . dol_print_date($act->datep, '%Y') . '&month=' . dol_print_date($act->datep, '%m') . '&day=' . dol_print_date($act->datep, '%d') . '">';
            ...
            $out .= '</a>';
            $out .= '</li><li class="noborder litext">';
            $out .= '<a href="' . constant('BASE_URL') . '/comm/action/peruser.php?mode=show_peruser&year=' . dol_print_date($act->datep, '%Y') . '&month=' . dol_print_date($act->datep, '%m') . '&day=' . dol_print_date($act->datep, '%d') . '">';
    ...
    if (($element_id || $element_ref) && $element == 'fichinter') {
        ...
        if (is_object($fichinter)) {
            ...
            // Intervention card
            $linkback = '<a href="' . constant('BASE_URL') . '/fichinter/list.php' . (!empty($socid) ? '?socid=' . $socid : '') . '">' . $langs->trans("BackToList") . '</a>';

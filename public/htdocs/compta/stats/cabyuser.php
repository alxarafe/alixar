...
if (count($amount)) {
    ...
    foreach ($arrayforsort as $key => $value) {
        ...
        $fullname = $name[$key];
        if ($key >= 0) {
            $linkname = '<a href="' . constant('BASE_URL') . '/user/card.php?id=' . $key . '">' . img_object($langs->trans("ShowUser"), 'user') . ' ' . $fullname . '</a>';
        } else {
        ...
        if ($modecompta == 'RECETTES-DEPENSES') {
            ...
            if ($key > 0) {
                print '<a href="' . constant('BASE_URL') . '/compta/facture/list.php?userid=' . $key . '">';
            } else {
                //print '<a href="#">';
            }
        ...
        if (isModEnabled("propal") && $key > 0) {
            print '&nbsp;<a href="' . constant('BASE_URL') . '/comm/propal/stats/index.php?userid=' . $key . '">' . img_picto($langs->trans("ProposalStats"), "stats") . '</a>&nbsp;';
        }
        if (isModEnabled('order') && $key > 0) {
            print '&nbsp;<a href="' . constant('BASE_URL') . '/commande/stats/index.php?userid=' . $key . '">' . img_picto($langs->trans("OrderStats"), "stats") . '</a>&nbsp;';
        }
        if (isModEnabled('invoice') && $key > 0) {
            print '&nbsp;<a href="' . constant('BASE_URL') . '/compta/facture/stats/index.php?userid=' . $key . '">' . img_picto($langs->trans("InvoiceStats"), "stats") . '</a>&nbsp;';
        }
        print '</td>';
        print "</tr>\n";
        $i++;

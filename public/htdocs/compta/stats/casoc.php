...
if (count($amount)) {
    ...
    foreach ($arrayforsort as $key => $value) {
        ...
        if ($modecompta != 'CREANCES-DETTES') {
            if ($key > 0) {
                print '<a href="' . constant('BASE_URL') . 'compta/paiement/list.php?socid=' . $key . '">';
            } else {
                print '<a href="' . constant('BASE_URL') . 'compta/paiement/list.php?socid=-1">';
            }
        } else {
            if ($key > 0) {
                print '<a href="' . constant('BASE_URL') . 'compta/facture/list.php?socid=' . $key . '">';
            } else {
                print '<a href="#">';
            }
        ...
        if ($modecompta != 'CREANCES-DETTES') {
            if ($key > 0) {
                ...
                print '<a href="' . constant('BASE_URL') . 'compta/paiement/list.php?orphelins=1">';
            }
        } else {
            if ($key > 0) {
                print '<a href="' . constant('BASE_URL') . 'compta/facture/list.php?socid=' . $key . '">';
        ...
        if (isModEnabled('order') && $key > 0) {
            print '&nbsp;<a href="' . constant('BASE_URL') . 'commande/stats/index.php?socid=' . $key . '">' . img_picto($langs->trans("OrderStats"), "stats") . '</a>&nbsp;';
        }
        if (isModEnabled('invoice') && $key > 0) {
            print '&nbsp;<a href="' . constant('BASE_URL') . 'compta/facture/stats/index.php?socid=' . $key . '">' . img_picto($langs->trans("InvoiceStats"), "stats") . '</a>&nbsp;';
        }
        print '</td>';
        print "</tr>\n";
        $i++;

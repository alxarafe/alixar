...
if (count($amount)) {
    ...
    foreach ($arrayforsort as $key => $value) {
        ...
        if ($modecompta != 'CREANCES-DETTES') {
            if ($key > 0) {
                print '<a href="' . constant('BASE_URL') . 'fourn/facture/paiement/list.php?socid=' . $key . '">';
            } else {
                print '<a href="' . constant('BASE_URL') . 'fourn/facture/paiement/list.php?socid=-1">';
            }
        } else {
            if ($key > 0) {
                print '<a href="' . constant('BASE_URL') . 'fourn/facture/list.php?socid=' . $key . '">';
            } else {
                print '<a href="#">';
            }
        ...
        if ($modecompta != 'CREANCES-DETTES') {
            if ($key > 0) {
                ...
                print '<a href="' . constant('BASE_URL') . 'fourn/facture/paiement/list.php?orphelins=1">';
            }
        } else {
            if ($key > 0) {
                print '<a href="' . constant('BASE_URL') . 'fourn/facture/list.php?socid=' . $key . '">';
        ...
        if (isModEnabled('supplier_proposal') && $key > 0) {
            print '&nbsp;<a href="' . constant('BASE_URL') . 'comm/propal/stats/index.php?socid=' . $key . '">' . img_picto($langs->trans("ProposalStats"), "stats") . '</a>&nbsp;';
        }
        if (isModEnabled("supplier_order") && $key > 0) {
            print '&nbsp;<a href="' . constant('BASE_URL') . 'commande/stats/index.php?mode=supplier&socid=' . $key . '">' . img_picto($langs->trans("OrderStats"), "stats") . '</a>&nbsp;';
        }
        if (isModEnabled("supplier_invoice") && $key > 0) {
            print '&nbsp;<a href="' . constant('BASE_URL') . 'compta/facture/stats/index.php?mode=supplier&socid=' . $key . '">' . img_picto($langs->trans("InvoiceStats"), "stats") . '</a>&nbsp;';
        }
        print '</td>';
        print "</tr>\n";
        $i++;

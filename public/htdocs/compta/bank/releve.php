...
if (empty($numref)) {
    ...
    if ($resql) {
        ...
        $linkback = '<a href="' . constant('BASE_URL') . '/compta/bank/list.php?restore_lastsearch_values=1">' . $langs->trans("BackToList") . '</a>';
        ...
        if ($object->canBeConciliated() > 0) {
            ...
            if ($user->hasRight('banque', 'consolidate')) {
                $buttonreconcile = '<a class="butAction" href="' . constant('BASE_URL') . '/compta/bank/bankentries_list.php?action=reconcile&sortfield=b.datev,b.dateo,b.rowid&sortorder=asc,asc,asc&search_conciliated=0&search_account=' . $id . $param . '">' . $titletoconciliatemanual . '</a>';
            } else {
            ...
            if ($allowautomaticconciliation) {
                ...
                if ($user->hasRight('banque', 'consolidate')) {
                    ...
                    $buttonreconcile .= ' <a class="butAction" style="margin-bottom: 5px !important; margin-top: 5px !important" href="' . constant('BASE_URL') . '/compta/bank/bankentries_list.php?action=reconcile&sortfield=b.datev,b.dateo,b.rowid&sortorder=asc,asc,asc&search_conciliated=0' . $newparam . '">' . $titletoconciliateauto . '</a>';
                } else {
    ...
    if ($resql) {
        ...
        while ($i < $num) {
            ...
            print '<a href="' . constant('BASE_URL') . '/compta/bank/line.php?rowid=' . $objp->rowid . '&account=' . $object->id . '">';
            $reg = array();

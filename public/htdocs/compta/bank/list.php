...
foreach ($accounts as $key => $type) {
    ...
    if ($mode == 'kanban') {
        ...
        if (!empty($arrayfields['toreconcile']['checked'])) {
            ...
            if ($conciliate == -2) {
                ...
                if (is_numeric($result) && $result < 0) {
                    ...
                    print '<a href="' . constant('BASE_URL') . '/compta/bank/bankentries_list.php?action=reconcile&sortfield=b.datev,b.dateo,b.rowid&sortorder=asc,asc,asc&id=' . $objecttmp->id . '&search_account=' . $objecttmp->id . '&search_conciliated=0&contextpage=banktransactionlist">';
        ...
        if (!empty($arrayfields['balance']['checked'])) {
            ...
            print '<a href="' . constant('BASE_URL') . '/compta/bank/bankentries_list.php?id=' . $objecttmp->id . '">';

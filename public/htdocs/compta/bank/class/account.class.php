...
class Account extends CommonObject
{
    ...
    public function load_board(User $user, $filteraccountid = 0)
    {
        ...
        if ($resql) {
            ...
            require_once constant('DOL_DOCUMENT_ROOT') . '/core/class/workboardresponse.class.php';
...
class AccountLine extends CommonObjectLine
{
    ...
    public function getNomUrl($withpicto = 0, $maxlen = 0, $option = '', $notooltip = 0)
    {
        ...
        $linkstart = '<a href="' . constant('BASE_URL') . '/compta/bank/line.php?rowid=' . ((int) $this->id) . '&save_lastsearch_values=1" title="' . dol_escape_htmltag($label, 1) . '" class="classfortooltip">';
        $linkend = '</a>';

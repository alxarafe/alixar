...
if ($result) {
    ...
    if ($db->num_rows($result)) {
        ...
        $linkback = '<a href="' . constant('BASE_URL') . '/compta/bank/bankentries_list.php?restore_lastsearch_values=1' . (GETPOSTINT('account', 1) ? '&id=' . GETPOSTINT('account', 1) : '') . '">' . $langs->trans("BackToList") . '</a>';
        ...
        if (count($links)) {
            ...
            foreach ($links as $key => $val) {
                ...
                if ($links[$key]['type'] == 'payment') {
                    ...
                    print '<a href="' . constant('BASE_URL') . '/compta/sociales/card.php?id=' . $links[$key]['url_id'] . '">';
                    ...
                    print '<a href="' . constant('BASE_URL') . '/compta/tva/card.php?id=' . $links[$key]['url_id'] . '">';
                    ...
                    print '<a href="' . constant('BASE_URL') . '/salaries/card.php?id=' . $links[$key]['url_id'] . '">';
                    print img_object($langs->trans('Salary'), 'bill') . ' ';
                    print $langs->trans("Salary") . ($links[$key]['label'] ? ' - ' . $links[$key]['label'] : '');
                    print '</a>';
                } elseif ($links[$key]['type'] == 'payment_sc') {
                    print '<a href="' . constant('BASE_URL') . '/compta/payment_sc/card.php?id=' . $links[$key]['url_id'] . '">';
                    print img_object($langs->trans('Payment'), 'payment') . ' ';
                    print $langs->trans("SocialContributionPayment");
                    print '</a>';
                } elseif ($links[$key]['type'] == 'payment_vat') {
                    print '<a href="' . constant('BASE_URL') . '/compta/payment_vat/card.php?id=' . $links[$key]['url_id'] . '">';
                    print img_object($langs->trans('VATPayment'), 'payment') . ' ';
                    print $langs->trans("VATPayment");
                    print '</a>';
                } elseif ($links[$key]['type'] == 'payment_salary') {
                    print '<a href="' . constant('BASE_URL') . '/salaries/payment_salary/card.php?id=' . $links[$key]['url_id'] . '">';
                    print img_object($langs->trans('PaymentSalary'), 'payment') . ' ';
                    print $langs->trans("SalaryPayment");
                    print '</a>';
                } elseif ($links[$key]['type'] == 'payment_loan') {
                    print '<a href="' . constant('BASE_URL') . '/loan/payment/card.php?id=' . $links[$key]['url_id'] . '">';
                    print img_object($langs->trans('LoanPayment'), 'payment') . ' ';
                    print $langs->trans("PaymentLoan");
                    print '</a>';
                } elseif ($links[$key]['type'] == 'loan') {
                    print '<a href="' . constant('BASE_URL') . '/loan/card.php?id=' . $links[$key]['url_id'] . '">';
                    print img_object($langs->trans('Loan'), 'bill') . ' ';
                    print $langs->trans("Loan");
                    print '</a>';
                } elseif ($links[$key]['type'] == 'member') {
                    print '<a href="' . constant('BASE_URL') . '/adherents/card.php?rowid=' . $links[$key]['url_id'] . '">';
                    print img_object($langs->trans('Member'), 'user') . ' ';
                    print $links[$key]['label'];
                    print '</a>';
                } elseif ($links[$key]['type'] == 'payment_donation') {
                    print '<a href="' . constant('BASE_URL') . '/don/payment/card.php?id=' . $links[$key]['url_id'] . '">';
                    ...
                    print '<a href="' . constant('BASE_URL') . '/compta/bank/line.php?rowid=' . $links[$key]['url_id'] . '">';
                    print img_object($langs->trans('Transaction'), 'payment') . ' ';
                    print $langs->trans("TransactionOnTheOtherAccount");
                    print '</a>';
                } elseif ($links[$key]['type'] == 'user') {
                    print '<a href="' . constant('BASE_URL') . '/user/card.php?id=' . $links[$key]['url_id'] . '">';
                    print img_object($langs->trans('User'), 'user') . ' ';
                    print $langs->trans("User");
                    print '</a>';
                } elseif ($links[$key]['type'] == 'payment_various') {
                    print '<a href="' . constant('BASE_URL') . '/compta/bank/various_payment/card.php?id=' . $links[$key]['url_id'] . '">';
        ...
        */
        ...
        if ($acct->canBeConciliated() > 0) {  // Si compte rapprochable
            ...
            if ($user->hasRight('banque', 'consolidate')) {
                ...
                if ($objp->num_releve) {
                    print ' &nbsp; <a href="' . constant('BASE_URL') . '/compta/bank/releve.php?num=' . $objp->num_releve . '&account=' . $acct->id . '">(' . $langs->trans("AccountStatement") . ' ' . $objp->num_releve . ')</a>';
                }
                print '</td>';
            } else {

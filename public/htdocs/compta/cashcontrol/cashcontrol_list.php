...
if ($num == 1 && getDolGlobalString('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
    ...
    $id = $obj->rowid;
    header("Location: " . constant('BASE_URL') . '/compta/cashcontrol/cashcontrol_card.php?id=' . $id);
    exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', constant('BASE_URL') . '/compta/cashcontrol/cashcontrol_card.php?action=create&backtopage=' . urlencode($_SERVER['PHP_SELF']), '', $permforcashfence);

...
#id-right { /* This must stay id-right and not be replaced with echo $right */
    width: 100%;
    padding-bottom: 20px;
<?php if (GETPOST('optioncss', 'aZ09') != 'print') { ?> padding- <?php print $left; ?>: <?php echo $leftmenuwidth + 9; ?>px;
    padding-top: 16px;
<?php } ?>
}
...
<?php
    if (in_array($conf->browser->layout, array('phone', 'tablet')) && !getDolGlobalString('MAIN_OPTIMIZEFORTEXTBROWSER')) {
    } else { ?> overflow-x: initial !important;
    overflow-y: scroll;
<?php } ?> display: block;
...
#id-left {
    ...
    /* padding-top: 20px; */
<?php
    if (in_array($conf->browser->layout, array('phone', 'tablet')) && !getDolGlobalString('MAIN_OPTIMIZEFORTEXTBROWSER')) { ?> top: 66px ! important;
<?php } else { ?> top: 60px ! important;
<?php } ?>
}
...
<?php if (!$disableimages) { ?> height: <?php print $heightmenu; ?>px;
    padding: 0px 0px 2px 0px;
<?php } else { ?> padding: 0px 0px 0px 0px;
<?php }
    } ?> position: relative;
    display: block;
    margin: 0px 0px 0px 0px;
...
div.tmenucenter {
    padding-left: 0px;
    padding-right: 0px;
<?php if ($disableimages) { ?> padding-top: 10px;
    height: 26px;
...
<?php print $left; ?>: 0;
<?php if (in_array($conf->browser->layout, array('phone', 'tablet')) && !getDolGlobalString('MAIN_OPTIMIZEFORTEXTBROWSER')) { ?> position: absolute;
...
.searchform .bordertransp {
    border: 0;
}

#divsearchforms2 form.searchform .button {
...
div.blockvmenufirst {
    padding-top: 10px;
<?php if (getDolGlobalString('MAIN_USE_TOP_MENU_SEARCH_DROPDOWN')) { ?> border-top: 1px solid #e0e0e0;
<?php } ?>
}
...
.liste_titre_bydiv {
<?php if ($userborderontable) { ?> border-right: 1px solid #ccc;
    border-left: 1px solid #ccc;
<?php } ?>
}
...
<?php
    ...
    border-left: 1px solid #ccc;
    border-right: 1px solid #ccc;
<?php } else { ?> border-left: 1px solid #f0f0f0;
...
<?php if ($userborderontable) { ?> border-top-width: <?php echo $borderwidth ?>px;
    border-top-color: var(--colortopbordertitle1);
    border-top-style: solid;

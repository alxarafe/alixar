...
<form method="post" name="formsoc" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
    ...
    <table class="border allwidth">
        ...
        <tr>
            ...
            <td colspan="3"><input name="email" type="text" class="minwidth200" maxlength="80"
        ...
        <tr>
            <td class="center" colspan="4"><input type="submit" class="button"
                                                  value="<?php echo $langs->trans("Add"); ?>"></td>
        </tr>

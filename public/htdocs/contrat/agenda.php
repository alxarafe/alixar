...
if ($object->id > 0) {
    ...
    $linkback = '<a href="' . constant('BASE_URL') . '/contrat/list.php?restore_lastsearch_values=1">' . $langs->trans("BackToList") . '</a>';
    ...
    if ((!empty($objthirdparty->id) || !empty($objcon->id)) && $permok)
    {
        ...
        if (get_only_class($objthirdparty) == 'Societe') $out.='&amp;socid='.$objthirdparty->id;

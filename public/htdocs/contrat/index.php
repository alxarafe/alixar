...
if ($resql) {
    ...
    while ($i < min($num, $max)) {
        ...
        if ($obj->fk_product > 0) {
            ...
            print '<a href="' . constant('BASE_URL') . '/contrat/card.php?id=' . $obj->fk_contrat . '">' . img_object($langs->trans("ShowService"), "service");
            if ($obj->label) {
        ...
        print $staticcompany->getNomUrl(1, '', 20);
        print '</td>';
        print '<td class="nowrap right"><a href="' . constant('BASE_URL') . '/contrat/card.php?id=' . $obj->fk_contrat . '&ligne=' . $obj->cid . '">';
...
if ($resql) {
    ...
    print '<tr class="liste_titre"><th colspan="4">' . $langs->trans("NotActivatedServices") . ' <a href="' . constant('BASE_URL') . '/contrat/services_list.php?mode=0"><span class="badge">' . $num . '</span></a></th>';
    print "</tr>\n";
...
if ($resql) {
    ...
    print '<tr class="liste_titre"><th colspan="4">' . $langs->trans("ListOfExpiredServices") . ' <a href="' . constant('BASE_URL') . '/contrat/services_list.php?search_status=4&amp;filter=expired"><span class="badge">' . $num . '</span></a></th>';
    print "</tr>\n";

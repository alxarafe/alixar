...
if ($num == 1 && getDolGlobalString('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
    ...
    $id = $obj->rowid;
    header("Location: " . constant('BASE_URL') . '/adherents/subscription/card.php?id=' . $id);
    exit;
}
...
if ($user->hasRight('adherent', 'cotisation', 'creer')) {
    ...
    $newcardbutton .= dolGetButtonTitle($langs->trans('NewSubscription'), '', 'fa fa-plus-circle', constant('BASE_URL') . '/adherents/list.php?status=-1,1');
}

...
if ($num == 1 && getDolGlobalString('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
    ...
    $id = $obj->rowid;
    header("Location: " . constant('BASE_URL') . '/adherents/card.php?id=' . $id);
    exit;
}
...
if ($user->hasRight('adherent', 'creer')) {
    ...
    $newcardbutton .= dolGetButtonTitle($langs->trans('NewMember'), '', 'fa fa-plus-circle', constant('BASE_URL') . '/adherents/card.php?action=create');
}

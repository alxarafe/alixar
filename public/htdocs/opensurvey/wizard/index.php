...
require_once constant('DOL_DOCUMENT_ROOT') . '/opensurvey/lib/opensurvey.lib.php';
...
print '<div><img class="opacity imgopensurveywizard" src="' . constant('DOL_URL_ROOT') . '/opensurvey/img/date.png" onclick="document.formulaire.date.click()"></div>';
print '<button id="date" name="choix_sondage" value="date" type="submit" class="button orange bigrounded">';
print '<img src="' . constant('DOL_URL_ROOT') . '/opensurvey/img/calendar-32.png" alt="' . dol_escape_htmltag($langs->trans("CreateSurveyDate")) . '" style="padding-right: 4px" class="inline-block valignmiddle">';
...
print '<div><img class="opacity imgopensurveywizard" src="' . constant('DOL_URL_ROOT') . '/opensurvey/img/sondage2.png" onclick="document.formulaire.autre.click()"></div>';
print '<button id="autre" name="choix_sondage" value="autre" type="submit" class="button blue bigrounded">';
print '<img src="' . constant('DOL_URL_ROOT') . '/opensurvey/img/chart-32.png" alt="' . dol_escape_htmltag($langs->trans("CreateSurveyStandard")) . '" style="padding-right: 4px" class="inline-block valignmiddle">';

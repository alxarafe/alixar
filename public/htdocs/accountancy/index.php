...
if (isModEnabled('accounting')) {
    ...
    if ($user->hasRight('accounting', 'chartofaccount')) {
        ...
        $s = str_replace('{s}', '<a href="' . constant('BASE_URL') . '/accountancy/admin/journals_list.php?id=35&&leftmenu=accountancy_admin" target="setupaccountancy"><strong>' . $langs->transnoentitiesnoconv("Setup") . ' - ' . $langs->transnoentitiesnoconv("AccountingJournals") . '</strong></a>', $s);
        print $s;
        print "<br>\n";
        $step++;
        $s = img_picto('', 'puce') . ' ' . $langs->trans("AccountancyAreaDescChartModel", $step, '{s}');
        $s = str_replace('{s}', '<a href="' . constant('BASE_URL') . '/accountancy/admin/accountmodel.php?search_country_id=' . $mysoc->country_id . '&leftmenu=accountancy_admin" target="setupaccountancy"><strong>' . $langs->transnoentitiesnoconv("Setup") . ' - ' . $langs->transnoentitiesnoconv("Pcg_version") . '</strong></a>', $s);
        print $s;
        print "<br>\n";
        $step++;
        $s = img_picto('', 'puce') . ' ' . $langs->trans("AccountancyAreaDescChart", $step, '{s}');
        $s = str_replace('{s}', '<a href="' . constant('BASE_URL') . '/accountancy/admin/account.php?leftmenu=accountancy_admin" target="setupaccountancy"><strong>' . $langs->transnoentitiesnoconv("Setup") . ' - ' . $langs->transnoentitiesnoconv("Chartofaccounts") . '</strong></a>', $s);
        print $s;
        if ($pcgver > 0) {
            $pcgversion = '';
            $pcglabel = '';
        ...
        if (getDolGlobalString('ACCOUNTANCY_FISCAL_PERIOD_MODE') != 'blockedonclosed') {
            ...
            $s = str_replace('{s}', '<a href="' . constant('BASE_URL') . '/accountancy/admin/fiscalyear.php?leftmenu=accountancy_admin" target="setupaccountancy"><strong>' . $langs->transnoentitiesnoconv("Setup") . ' - ' . $langs->transnoentitiesnoconv("FiscalPeriod") . '</strong></a>', $s);
            print $s;
            print "<br>\n";
        }
        ...
        $s = str_replace('{s}', '<a href="' . constant('BASE_URL') . '/accountancy/admin/defaultaccounts.php?leftmenu=accountancy_admin" target="setupaccountancy"><strong>' . $langs->transnoentitiesnoconv("Setup") . ' - ' . $langs->transnoentitiesnoconv("MenuDefaultAccounts") . '</strong></a>', $s);
        print $s;
        print "<br>\n";

        $step++;
        $s = img_picto('', 'puce') . ' ' . $langs->trans("AccountancyAreaDescBank", $step, '{s}') . "\n";
        $s = str_replace('{s}', '<a href="' . constant('BASE_URL') . '/compta/bank/list.php?leftmenu=accountancy_admin" target="setupaccountancy"><strong>' . $langs->transnoentitiesnoconv("Setup") . ' - ' . $langs->transnoentitiesnoconv("MenuBankAccounts") . '</strong></a>', $s);
        print $s;
        print "<br>\n";

        $step++;
        $textlink = '<a href="' . constant('BASE_URL') . '/admin/dict.php?id=10&from=accountancy&leftmenu=accountancy_admin" target="setupaccountancy"><strong>' . $langs->transnoentitiesnoconv("Setup") . ' - ' . $langs->transnoentitiesnoconv("MenuVatAccounts") . '</strong></a>';
        ...
        if (isModEnabled('tax')) {
            $textlink = '<a href="' . constant('BASE_URL') . '/admin/dict.php?id=7&from=accountancy&leftmenu=accountancy_admin" target="setupaccountancy"><strong>' . $langs->transnoentitiesnoconv("Setup") . ' - ' . $langs->transnoentitiesnoconv("MenuTaxAccounts") . '</strong></a>';
            $step++;
        ...
        if (isModEnabled('expensereport')) {  // TODO Move this in the default account page because this is only one accounting account per purpose, not several.
            ...
            $s = str_replace('{s}', '<a href="' . constant('BASE_URL') . '/admin/dict.php?id=17&from=accountancy&leftmenu=accountancy_admin"><strong>' . $langs->transnoentitiesnoconv("Setup") . ' - ' . $langs->transnoentitiesnoconv("MenuExpenseReportAccounts") . '</strong></a>', $s);
            print $s;
            print "<br>\n";
        }
        ...
        $s = str_replace('{s}', '<a href="' . constant('BASE_URL') . '/accountancy/admin/productaccount.php?leftmenu=accountancy_admin" target="setupaccountancy"><strong>' . $langs->transnoentitiesnoconv("Setup") . ' - ' . $langs->transnoentitiesnoconv("ProductsBinding") . '</strong></a>', $s);
        print $s;
        print "<br>\n";
    ...
    $s = str_replace('{s}', '<a href="' . constant('BASE_URL') . '/accountancy/customer/index.php" target="setupaccountancy"><strong>' . $langs->transnoentitiesnoconv("TransferInAccounting") . ' - ' . $langs->transnoentitiesnoconv("CustomersVentilation") . '</strong></a>', $s);
    print $s;
    print "<br>\n";

    $step++;
    $s = img_picto('', 'puce') . ' ' . $langs->trans("AccountancyAreaDescBind", chr(64 + $step), $langs->transnoentitiesnoconv("BillsSuppliers"), '{s}') . "\n";
    $s = str_replace('{s}', '<a href="' . constant('BASE_URL') . '/accountancy/supplier/index.php" target="setupaccountancy"><strong>' . $langs->transnoentitiesnoconv("TransferInAccounting") . ' - ' . $langs->transnoentitiesnoconv("SuppliersVentilation") . '</strong></a>', $s);
    print $s;
    print "<br>\n";
    ...
    if (isModEnabled('expensereport') || isModEnabled('deplacement')) {
        ...
        $s = str_replace('{s}', '<a href="' . constant('BASE_URL') . '/accountancy/expensereport/index.php" target="setupaccountancy"><strong>' . $langs->transnoentitiesnoconv("TransferInAccounting") . ' - ' . $langs->transnoentitiesnoconv("ExpenseReportsVentilation") . '</strong></a>', $s);
        print $s;
        print "<br>\n";
    }

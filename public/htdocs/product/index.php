...
ViewMain::llxHeader("", $langs->trans("ProductsAndServices"), $helpurl, '', 0, 0, '', '', '', 'mod-product page-index');
...
if ((isModEnabled("product") || isModEnabled("service")) && ($user->hasRight("produit", "lire") || $user->hasRight("service", "lire"))) {
    ...
    if ($result) {
        ...
        if ($num > 0) {
            ...
            $lastmodified .= '<a href="' . constant('BASE_URL') . '/product/list.php?sortfield=p.tms&sortorder=DESC" title="' . $langs->trans("FullList") . '">';
...
if (isModEnabled('stock')) {
    ...
    if ($result) {
        ...
        $latestwarehouse .= '<a href="' . constant('BASE_URL') . '/product/stock/list.php?sortfield=p.tms&sortorder=DESC" title="' . $langs->trans("FullList") . '">';
...
if (isModEnabled('stock')) {
    ...
    if ($resql) {
        ...
        $latestmovement .= '<a class="notasortlink" href="' . constant('BASE_URL') . '/product/stock/movement_list.php">';

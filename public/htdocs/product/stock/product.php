...
if ($id > 0 || $ref) {
    ...
    if ($result > 0) {
        ...
        if (!$variants) {
            ...
            print ' &nbsp; &nbsp;<a href="' . constant('BASE_URL') . '/product/stock/stockatdate.php?productid=' . $object->id . '">' . $langs->trans("StockAtDate") . '</a>';
            print '</td>';
            print '</tr>';
            ...
            print ' &nbsp; &nbsp;<a href="' . constant('BASE_URL') . '/product/stock/stockatdate.php?mode=future&productid=' . $object->id . '">' . $langs->trans("VirtualStockAtDate") . '</a>';
            print '</td>';
            print '</tr>';
            ...
            if ($user->hasRight('stock', 'mouvement', 'lire')) {
                ...
                if ($lastmovementdate) {
                    ...
                    print '<a href="' . constant('BASE_URL') . '/product/stock/movement_list.php?idproduct=' . $object->id . '">' . $langs->trans("FullList") . '</a>';
                } else {
                    print img_picto($langs->trans("StockMovement"), 'movement', 'class="pictofixedwidth"');
                    print '<a href="' . constant('BASE_URL') . '/product/stock/movement_list.php?idproduct=' . $object->id . '">' . $langs->trans("None") . '</a>';
                }
                print "</td></tr>";
            }

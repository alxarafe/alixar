...
if ($result) {
    ...
    print '<a href="' . constant('BASE_URL') . '/product/stock/list.php">';
...
if ($resql) {
    ...
    print '<th class="right"><a class="notasortlink" href="' . constant('BASE_URL') . '/product/stock/movement_list.php">' . $langs->trans("FullList") . '</a></th>';
    print "</tr>\n";

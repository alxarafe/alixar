    ...
    if ($action == 'create' && $usercancreate) {
        ...
        if (empty($reshook)) {
            ...
            if (($type != 1 || getDolGlobalInt('STOCK_SUPPORTS_SERVICES')) && isModEnabled('stock')) {
                ...
                print ' <a href="' . constant('BASE_URL') . '/product/stock/card.php?action=create&token=' . newToken() . '&backtopage=' . urlencode($_SERVER['PHP_SELF'] . '?&action=create&type=' . GETPOSTINT('type')) . '">';

...
if ($id > 0 || !empty($ref)) {
    ...
    if ($result > 0) {
        ...
        $linkback = '<a href="' . constant('BASE_URL') . 'product/list.php?restore_lastsearch_values=1">' . $langs->trans("BackToList") . '</a>';
            ...
            */
            ...
            if ($num > 0) {
                while ($i < min($num, $limit)) {
                    ...
                    print "</td>\n";
                    print '<td><a href="' . constant('BASE_URL') . 'comm/card.php?socid=' . $objp->socid . '">' . img_object($langs->trans("ShowCompany"), "company") . ' ' . dol_trunc($objp->name, 44) . '</a></td>';

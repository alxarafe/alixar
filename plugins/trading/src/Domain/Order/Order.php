...
namespace Plugin\Trading\Domain\Order;

use DateTimeImmutable;
use RuntimeException;

/**
 * Order — Entidad de Dominio para Pedidos de Venta.
 */
class Order
{
    private ?int $id;
    ...
    private int $status; // 0=Draft, 1=Validated, 2=Accepted/Shipped, 3=Delivered
    ...
    public static function fromArray(array $data): self
    {
        if (!isset($data['thirdPartyId']) && !isset($data['socid'])) {
            throw new RuntimeException("Falta campo obligatorio 'thirdPartyId' al hidratar Order.");
        }

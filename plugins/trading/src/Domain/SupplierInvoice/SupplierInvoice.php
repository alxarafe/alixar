...
namespace Plugin\Trading\Domain\SupplierInvoice;

use DateTimeImmutable;
use RuntimeException;

/**
 * SupplierInvoice — Entidad de Dominio para Facturas de Compra (Proveedores).
 */
class SupplierInvoice
{
    ...
    public static function fromArray(array $data): self
    {
        if (!isset($data['thirdPartyId']) && !isset($data['socid'])) {
            throw new RuntimeException("Falta campo obligatorio 'thirdPartyId' al hidratar SupplierInvoice.");
        }

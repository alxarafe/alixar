...
class MysqlReceptionRepository implements ReceptionRepository
{
    ...
    public function __construct(
        ...
        $this->tableName = $prefix . 'receptions';
    }
    ...
    private function insert(Reception $item): void
    {
    ...
    private function update(Reception $item): void
    {
    ...
    private function mapRowToEntity(array $row): Reception
    {
        return Reception::fromArray([
            'id' => (int) $row['id'],
            'ref' => $row['ref'],
            'refExt' => $row['ref_ext'],
    ...
    private function extractParams(Reception $item): array
    {
        $arr = $item->toArray();
        return [
            'ref' => $arr['ref'] ?? null,

...
namespace Plugin\Business\Infrastructure\Http\Api\Controller;

use Plugin\Business\Domain\ThirdParty\ThirdParty;
use Plugin\Business\Domain\ThirdParty\ThirdPartyNotFoundException;
...
class ThirdPartyApiController
{
    ...
    public function __construct(
        ...
        private \Plugin\Business\Domain\ThirdParty\ThirdPartyValidator $validator,
        private ?\Plugin\Business\Domain\BankAccount\BankAccountRepository $bankAccountRepository = null,
        private ?\Plugin\Business\Domain\Category\ThirdPartyCategoryRepository $categoryRepository = null,
        private ?\Plugin\Business\Domain\User\ThirdPartyRepresentativeRepository $representativeRepository = null,
    ) {
    }
    ...
    public function create(): void
    {
        ...
        $tp = new ThirdParty(
            ...
            type: \Plugin\Business\Domain\ThirdParty\ThirdPartyType::from((int) ($cleanData['type'] ?? 0)),
            isSupplier: (bool) ($cleanData['isSupplier'] ?? false),
            status: isset($cleanData['status'])
                ? \Plugin\Business\Domain\ThirdParty\ThirdPartyStatus::from((int) $cleanData['status'])
                : null,
    ...
    public function getRepresentatives(int $id): void
    {
        ...
        Flight::json(array_map(fn(\Plugin\Business\Domain\User\Representative $user) => $user->toArray(), $users));
    }

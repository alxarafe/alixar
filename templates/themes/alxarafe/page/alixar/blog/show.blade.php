            ...
            <article class="post-content">
                <header class="mb-5">
                    <div class="d-flex align-items-center gap-2 mb-3">
                        ...
                        @if($me->isAdmin())
                            <a href="index.php?module=Alixar&controller=Blog&action=edit&id={{ $post->id }}" class="btn btn-sm btn-link text-muted text-decoration-none">
                ...
                <footer class="mt-5 pt-5 border-top">
                    <div class="d-flex justify-content-between align-items-center">
                        <a href="?module=Alixar&controller=Blog&action=index" class="btn btn-outline-primary rounded-pill">

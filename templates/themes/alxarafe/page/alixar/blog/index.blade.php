...
<div class="hero-section">
    <div class="container">
        ...
        <div class="mt-5">
            <a href="index.php?module=Alixar&controller=Blog&action=show&slug=manifiesto-ia" class="btn-alx">Manifiesto IA</a>
        </div>
    </div>
</div>
    ...
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-md-4">
            <div class="feature-card">
                ...
                <a href="index.php?module=Alixar&controller=Blog&action=show&slug=manifiesto-ia" class="btn-outline-alx">Manifiesto IA <i class="fas fa-arrow-right ms-2"></i></a>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="feature-card">
                ...
                @if(!$posts->isEmpty())
                    <a href="?module=Alixar&controller=Blog&action=index" class="btn-outline-alx">Blog <i class="fas fa-arrow-right ms-2"></i></a>
                @else
    ...
    @if(!$posts->isEmpty())
        <div class="mt-5 pt-5 border-top">
            <div class="d-flex justify-content-between align-items-end mb-5">
                <div>
                    <h2 class="h1 fw-800 text-secondary mb-0">Últimos Artículos</h2>
                    <p class="text-muted">Novedades desde el laboratorio de Alxarafe</p>
                </div>
                <a href="?module=Alixar&controller=Blog&action=index" class="btn btn-link text-primary fw-bold text-decoration-none p-0">
                    ...
                    <div class="col-md-4">
                        <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden card-hover">
                            <div class="card-body p-4">
                                ...
                                <a href="?module=Alixar&controller=Blog&action=show&slug={{ $post->slug }}" class="text-decoration-none fw-bold small">

...
return new class extends Migration {
    ...
    {
        Capsule::schema()->create('emailcollector_emailcollector', function (Blueprint $table) {
            $table->id("rowid");
            ...
            $table->string('source_directory', 255)->default('Inbox');
            $table->string('target_directory', 255)->nullable();
    ...
    {
        Capsule::schema()->dropIfExists('emailcollector_emailcollector');
    }
};

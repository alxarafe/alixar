...
return new class extends Migration {
    ...
    {
        Capsule::schema()->create('facture', function (Blueprint $table) {
            $table->id("rowid");
            $table->string('ref', 30);
            ...
            $table->string('payment_reference', 25)->nullable();
            ...
            $table->decimal('prorata_discount')->nullable();
            $table->integer('situation_cycle_ref')->nullable();
            $table->integer('situation_counter')->nullable();
            $table->integer('situation_final')->nullable();
            $table->decimal('retained_warranty')->nullable();
            ...
            $table->integer('is_also_delivery_note')->default(0);
    ...
    {
        Capsule::schema()->dropIfExists('facture');
    }
};
